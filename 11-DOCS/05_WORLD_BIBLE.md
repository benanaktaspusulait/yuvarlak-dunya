...
Pompom Hills is a gentle preschool world where everything is round, safe, and encourages discovery.
...
| Attribute | Detail |
|-----------|--------|
| **Purpose** | The heart of Pompom Hills. Everyone meets here. |
| **Visual identity** | Round plaza, Big Pompom Tree, stepping stones, pastel houses |
| **Atmosphere** | Warm, welcoming, communal |
| **Lighting** | Soft daylight, warm tones |
| **Typical stories** | Group activities, discoveries, celebrations |
...
| Attribute | Detail |
|-----------|--------|
| **Purpose** | Opa's home and storytelling place |
| **Visual identity** | Large round tree, golden perch, reading platforms |
| **Atmosphere** | Wise, calm, safe |
| **Lighting** | Warm daylight, soft shadows |
| **Typical stories** | Learning moments, bedtime stories, quiet discoveries |
...
| Attribute | Detail |
|-----------|--------|
| **Purpose** | Nighttime version of Opa's Tree |
| **Visual identity** | Same tree, dark blue sky, soft moonlight, stars |
| **Atmosphere** | Dreamy, wonder, bedtime |
| **Lighting** | Soft moonlight, starlight twinkle |
| **Typical stories** | Star gazing, nighttime discoveries |
...
| Attribute | Detail |
|-----------|--------|
| **Purpose** | Gentle rocky hill for discovery |
| **Visual identity** | Smooth round stones, gentle slopes |
| **Atmosphere** | Curious, exploratory |
| **Lighting** | Soft daylight |
| **Typical stories** | Stone discoveries, nature exploration |
...
*This document is the master reference for every location.*
*Source of truth for: World design, atmosphere, production status*

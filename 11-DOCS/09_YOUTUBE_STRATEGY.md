...
- Evergreen content over trending
...
| Playlist | Purpose |
|----------|---------|
| Full Episodes | Main content |
| Character Intros | Discovery |
...
> **Superseded by the permanent metadata standard:** all title, description, tag, hashtag and Shorts metadata now follow `00-CORE/30_YOUTUBE_METADATA_STANDARD.md`. Use that document for every future video; do not improvise metadata format.

- Title: Character + Action + Object + Emoji + "PomPom Hills"
- Description: Summary + learning + CTA
- Tags: 15–20 terms
...
| Milestone | Criteria |
|-----------|----------|
| First Video | S01E01 uploaded |
| 100 Subscribers | Community forming |
| 1,000 Subscribers | Channel established |
| 10,000 Subscribers | Growth accelerating |

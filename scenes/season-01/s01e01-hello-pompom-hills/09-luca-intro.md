# Scene 09 - Luca Introduces Himself v3.0
...
| Alan | Değer |
| --- | --- |
| Luca konumu | X=0 / Z=0, merkezde, dürbünüyle bakar |
...
| --- | --- | --- | --- |
| Luca | 0 | 0 | Merkezde |
| Taşlar | -15 ~ 15 | 0 ~ 20 | Kavisli patika yukarı |
| Dürbün | 0 | 10 | Luca'nın elinde |
| Kamera | — | — | 0.85 m |
...
| --- | --- | --- |
| Luca | X=0 / Z=0 (dürbünüyle bakar) | X=0 / Z=0 (koşarak gider) |

## Prop Positions

| Prop | Başlangıç | Bitiş | Durum |
| --- | --- | --- | --- |
| Dürbün | Luca'nın elinde | Luca'nın elinde | İndirilmiş |
...
| Taşlar | Yuvarlak pastel renkli taşlar (sarı, pembe, mavi) |
| Patika | Kavisli yolu taşlar yukarı çıkar |
| Dürbün | Yuvarlak, güvenli dürbün |
| Genel his | Maceracı, enerjik, meraklı, yukarı bakan |
...
| Müzik | Yok |
| Karakter sesi | Luca: maceracı, enerjik, 100-115 kelime/dk |
| Sound FX | Adım "tap" sesi (yuvarlak taşlarda) |
| Yasak sesler | Bağırma, gürültü, korkutucu sesler |

## Pedagojik Amaç

3-4 yaş izleyici için Luca maceracı ve enerjik bir çocuk olarak tanıtılır. Dürbünle bakarken seenılır, "birlikte keşfedelim" mesajı verilir.
...
| Alan | Değer |
| --- | --- |
| Binocular lift | Dürbünü gözlerine yavaşça kaldırır, 15 frame |
| Point gesture | Parmekle uzak noktaya işaret, 12 frame |
| Run-out | Koşarak sahneyi terk eder, 50 birim/sn |
| Hair toss | Dağınık saç her harekette sallanır |
...
- Dürbün yuvarlak, güvenli.
- Koşma kontrollü.
- Gökyüzü her zaman aydınlık.
- Taşlar yumuşak, yuvarlak.
- Sivri köşe, tehlikeli nesne yok.
- Maksimum 1 konuşan karakter (Luca).

...
| **Bitmiş 16:9 master → 9:16 smart story-aware reframe** | `POMPOM_HILLS_PRODUCTION/00_GLOBAL_RULES/SHORTS_SMART_REFRAME_STANDARD.md` |
...
| **TTS ses değiştirme (voice replacement)** | `00-CORE/TTS_VOICE_REPLACEMENT_WORKFLOW.md` |

...
## Ana Mekan: Opa's Tree (`environment/06-opas-tree/hero-view.png`)

### Karakter Konumları

| Karakter | Başlangıç | Bitiş | Not |
| --- | --- | --- | --- |
| Kiko | TBD | TBD | Ağaca gelir, yere oturur |
| Opa | TBD | TBD | Daldan iner, yanına oturur |

### Prop Konumları

| Prop | Başlangıç | Bitiş | Durum |
| --- | --- | --- | --- |
| Düşen yapraklar | TBD | TBD | Yavaşça süzülür |
...
| 02 | Medium → Medium close-up | 0.80 m | Eye level |
| 03 | Close-up | 0.80 m | Eye level |
...
| Alan | Değer |
| --- | --- |
| Saat | Sabah → gün batımı (son shot altın ışık) |
| Bulut sayısı | 2 |

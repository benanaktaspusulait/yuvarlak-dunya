...
| --- | --- |
| Karakter | Noah |
| Mekan | Central Square — Pompom Hills |
| Ana duygu | Yaratıcılık |
| Pedagojik hedef | Çocuk izleyici Noah'ın adını, yaratıcı kişiliğini ve eğlence sevgisini öğrenir |
...
| Alan | Değer |
| --- | --- |
| Arda konumu | X=0 / Z=0, merkezde |
| Kamera | 0.70 m, 35mm wide |
...
| Element | X | Z | Not |
| --- | --- | --- | --- |
| Noah | 0 | 0 | Merkezde, oturuyor |
| Bloklar | -15 | 5 | Noah'un önünde |
| Kamera | — | — | 0.80 m |
...
| --- | --- | --- |
| Noah | X=0 / Z=0 (oturuyor) | X=0 / Z=0 (oturuyor) |

## Prop Positions

| Prop | Başlangıç | Bitiş | Durum |
| --- | --- | --- | --- |
| Bloklar | X=-15 / Z=5 | X=-15 / Z=5 | Noah'un önünde |
...
| Ağaç | Büyük ponpon ağaç arka planda |
| Taşlar | Yuvarlak renkli taşlar etrafta |
| Bloklar | Yuvarlak köşeli renkli bloklar (sarı, kırmızı, mavi) |
| Genel his | Yaratıcı, eğlenceli, meraklı |
...
| Müzik | Yok |
| Karakter sesi | Noah: neşeli, yaratıcı, 100-115 kelime/dk |
| Sound FX | Blok "click" sesi (yuvarlak, yumuşak), fikir geldiğinde hafif "ting" |
| Yasak sesler | Bağırma, gürültü, sert çarpma |
...
| Beat | Süre | Aksiyon |
| --- | ---: | --- |
| 1 | 0-4 sn | Noah oturur, blokları dizer |
| 2 | 4-8 sn | Bloklar devrilir, Noah gülümser |
| 3 | 8-12 sn | Yeni fikirle parmağını kaldırır |
| 4 | 12-15 sn | Blokları yeniden dizer, gururla bakar |
...
| Alan | Değer |
| --- | --- |
| Block stack | Bloklar 2 frame aralıkla dizilir |
| Block fall | Bloklar yumuşak şekilde devrilir |
| Idea gesture | Parmağını havaya kaldırır, 12 frame |
| Curl bounce | Saç kıvırcıkları hafifçe sallanır |
| Expression | Düşünceli → mutlu → gururlu |
| Squash-stretch | Max %4 |
...
| Alan | Değer |
| --- | --- |
| Noah konumu | X=0 / Z=0, oturuyor, gururlu |
...
- Bloklar yuvarlak köşeli, sert değil.
- Devrilme yumuşak; gürültü yok.

# Colours Everywhere — Shot 02 — Exploring With Mimi
...
```text
Mimi joins. They explore colours. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Medium, 50mm, tracking, no other characters, {style} {camera} {lighting}
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | Mimi joins. They explore colours. | Medium, 50mm, tracking |

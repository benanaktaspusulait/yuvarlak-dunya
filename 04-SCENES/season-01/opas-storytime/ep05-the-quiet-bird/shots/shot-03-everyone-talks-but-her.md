# The Quiet Bird — Shot 03 — Everyone Talks But Her
...
```text
Use Shot 02 video as Video Reference. Close-up on book page with soft bird illustrations (no readable text), Mimi reacting quietly, recognising herself, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 02 reference. Only after the first frame matches, hold a static close-up on the book detail. Lens 50mm, height 0.60m, static close-up (book detail).

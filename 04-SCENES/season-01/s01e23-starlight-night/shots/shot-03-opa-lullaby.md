# Starlight Night — Shot 03 — Opa Lullaby
...
```text
Opa hums a lullaby. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Gentle focus shift, 50mm, static, no other characters, {style} {camera} {lighting}
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | Opa hums a lullaby. | Gentle focus shift, 50mm, static |

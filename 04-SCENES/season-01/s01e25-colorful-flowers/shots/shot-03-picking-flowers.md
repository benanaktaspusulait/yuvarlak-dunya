# Colorful Flowers — Shot 03 — Picking Flowers
...
```text
They pick flowers together. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Medium, 50mm, static, no other characters, {style} {camera} {lighting}
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | They pick flowers together. | Medium, 50mm, static |

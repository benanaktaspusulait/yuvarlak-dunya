...
The viewer should clearly understand that Mimi feels something positive but does not know its name. Continue directly from Shot 02 and make Mimi’s uncertainty visually readable through one paw near her upper chest, thoughtful eye direction, a small head tilt, gentle ear movement, and a steady look toward the clean left entrance lane.

## @image1 Source

@image1 = corrected approved Shot 02 final frame. The ONLY visual continuity source.

Preserve the exact actual state of the corrected approved Shot 02 final frame. Do not clean, rebuild, improve, or reinterpret any character position, flower, hill, path, object, focus, crop, or colour.

## Character References

Use the approved Mimi character reference for identity only. It must never override Mimi's pose, position, scale, camera, crop, lighting, world layout, visible flowers, background focus, colour balance, or any visible state from @image1. Do not attach Kiko or any other character reference.
...
Use @image1 as the complete and only visual continuity master. Mimi must remain excited, curious, and gently confused. She must not appear dizzy, frightened, overwhelmed, distressed, or unsteady. Her movement stays small and readable, with both feet grounded throughout.
...
“My tummy feels fizzy. What is this feeling?”

Post-production dialogue timing:
- Begin at approximately 1.2 seconds.
- Finish by approximately 4.2 seconds.
- Do not repeat the same question in captions and dialogue for the entire shot.

Post-production text:

`WHAT IS THIS FEELING?`

Show it briefly during the question and remove it before Kiko enters.
...
- Duration: 15 seconds
- @image1: corrected approved Shot 02 final frame
...
Recommended final edit range: approximately 0.25/0.35–6.5 seconds.

...
Mimi performs exactly three small hops and notices two clear body clues: her feet keep bouncing and her tummy feels fizzy.

## @image1 Source

@image1 = corrected approved Shot 01 final frame. The ONLY visual continuity source.

Mimi must begin exactly where and how she ended Shot 01. Preserve the actual approved final frame even if any flower, hill, path, character position, or visible object is imperfect. Do not assume or create a cleaner state.

## Character References

Use the approved Mimi character reference for identity only. It must never override Mimi's pose, position, scale, camera, crop, lighting, world layout, visible flowers, background focus, colour balance, or any other visible state from @image1. Do not attach Kiko or any other character reference.
...
No static or meaningless waiting period may last longer than approximately 0.5 seconds. During dialogue, use only small readable performance such as eye contact, gentle ear movement, one small head movement, subtle breathing, a small expression change, or one controlled paw gesture. Do not create constant random movement; every movement must support the current line or emotion. The final 2.5 seconds may remain a stable continuity anchor, but the character must still have subtle natural breathing or tiny ear movement.

Use @image1 as the complete and only visual continuity master. Mimi, the clean left-side lane, the Flower Hill environment, and every visible object must begin and remain exactly where @image1 places them. Exactly three visible hops occur. Each hop is separate, vertical, small, controlled, and in place. Mimi lands fully and pauses briefly between hops.
...
- 0.0–0.20s: Frame 1 exactly matches the approved Shot 01 final frame. Mimi immediately continues subtle natural movement.
- 0.20–1.30s: First small in-place hop and full landing.
- 1.30–1.60s: Brief grounded reaction.
- 1.60–2.70s: Second small in-place hop and full landing.
- 2.70–3.00s: Brief grounded reaction.
- 3.00–4.10s: Third small in-place hop and full landing.
- 4.10–6.80s: Mimi looks down toward her feet and comments that they keep bouncing.
- 6.80–8.20s: Mimi carefully presses both feet into the ground as if testing whether they can remain still.
- 8.20–10.80s: Mimi places one paw gently near her tummy and notices the fizzy feeling.
- 10.80–11.30s: Mimi gives one small happy, curious smile while remaining fully grounded.
- 11.30–14.00s: Mimi looks thoughtful and says, “I wonder what this feeling is called.”
- 14.00–14.20s: Mimi holds the thoughtful expression with active eye focus.
- 14.20–15.00s: Stable curious final anchor.

## Final-State Requirement

Mimi ends fully visible, securely grounded, and in a stable readable pose. Her position and scale remain continuous with @image1, and she does not travel sideways. The Flower Hill layout, clean left-side entrance lane, visible objects, camera, crop, lighting, colour, focus, and depth of field remain unchanged. The final 0.8 seconds form a stable next-shot anchor.
...
Continue the uninterrupted Flower Hill ambience. Keep exactly three soft boing sound effects, one precisely synchronized with each hop. The first boing should feel curious, the second slightly brighter and the third cheerful, while all three remain tonally consistent. Optional soft landing taps may accompany the hops. Do not layer spoken “boing” dialogue over the boing sound effects. Use no bird chirps during the hops. One distant chirp may occur only after the third hop, during Mimi's puzzled reaction.
...
“Again? My feet keep bouncing!”

Post-production dialogue timing:
- Begin after the third landing, approximately 4.2 seconds.
- Finish by approximately 6.8 seconds.

Mimi:

“And my tummy feels fizzy!”

Post-production dialogue timing:
- Begin at approximately 8.5 seconds.
- Finish by approximately 10.8 seconds.
...
Post-production dialogue timing:
- Begin at approximately 11.3 seconds.
- Finish by approximately 14.0 seconds.

Keep exactly three soft post-production boing sound effects. Align each boing precisely with one hop. Do not add spoken boing sounds. The dialogue must not overlap the three boing effects. Do not use loud, chaotic, or overlapping effects.

Do not repeat these body-clue lines in Shot 03.

Do not generate spoken dialogue, on-screen dialogue, subtitles, captions, speech bubbles, or boing effects inside OpenArt. Dialogue and the three soft boing sound effects are added in post-production.
...
- Duration: 15 seconds
- @image1: corrected approved Shot 01 final frame
- World: approved Flower Hill
- Character references: approved Mimi only

# Colorful Flowers — Shot 06 — Arrange by Colour
...
Previous shot: They picked flowers together — red, yellow, purple. They each hold a small bunch.

Now they sit on the grass and arrange the flowers by colour.
...
Sofia and Kiko sit on the soft grass. They arrange their picked flowers in a row — red, yellow, blue, purple. Sofia places each one carefully. Kiko watches and helps. Painting Garden — soft pastel garden, warm morning light, flower row on grass. Medium, 50mm, gentle push-in, {style} {camera} {lighting}

Do not display dialogue as on-screen text. No speech bubbles. No captions. No subtitles. No text.

The Painting Garden background is locked from the first frame; keep all visible flowers, grass, garden elements and environment stable throughout the shot.
```
...
```
Sofia: Red here... yellow here... blue here...
Kiko: And purple!
```
...
| Time | Action | Camera |
|---|---|---|
| 0-3 sn | First frame matches previous shot. They sit on the grass with flowers. | Medium, 50mm, static |
| 3-7 sn | Sofia places the red flower, then the yellow one in a row. | Medium, 50mm, push-in begins |
| 7-10 sn | Kiko places the blue flower next to the yellow. | Medium, 50mm, push-in |
| 10-13 sn | Sofia places the purple flower at the end. "And purple!" | Medium, 50mm, push-in settles |
| 13-15 sn | They look at the row of colourful flowers. Proud smiles. | Medium, 50mm, static |
...
- Soft grass rustling
- Flower placement sounds — gentle touches
- Sofia and Kiko's counting voices

# The Garden Helper — Shot 03 — Talking To Plants
...
```text
They talk to plants gently. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Gentle focus shift, 50mm, static, no other characters, {style} {camera} {lighting}
...
```
Tillo: Say hello to the flowers!
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Tillo leans close to a flower, looking at it gently | Gentle focus shift, 50mm, static |
| 1-3 sn | He speaks softly to the flower, tilting his head | Gentle focus shift, 50mm, static |
| 3-5 sn | Kiko kneels beside another flower, watching | Gentle focus shift, 50mm, static |
| 5-7 sn | Kiko speaks to her flower too, waving gently at it | Gentle focus shift, 50mm, static |
| 7-10 sn | Tillo gestures for Kiko to touch a leaf softly | Gentle focus shift, 50mm, static |
| 10-13 sn | Kiko touches the leaf, giggles softly | Gentle focus shift, 50mm, static |
| 13-15 sn | Both look at the plants, smiling warmly | Gentle focus shift, 50mm, static |

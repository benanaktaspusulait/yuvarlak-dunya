# Painting Day — Shot 03 — Different Paintings
...
```
Sofia: Your flower is so pretty!
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Sofia paints a tree on her canvas, focused | Gentle focus shift, 50mm, static |
| 1-3 sn | She adds branches, tongue out in concentration | Gentle focus shift, 50mm, static |
| 3-5 sn | Kiko paints a flower on her canvas, leaning in | Gentle focus shift, 50mm, static |
| 5-7 sn | She adds petals, humming softly | Gentle focus shift, 50mm, static |
| 7-10 sn | Sofia glances at Kiko's flower, speaks warmly | Gentle focus shift, 50mm, static |
| 10-13 sn | Kiko looks at Sofia's tree, smiles, nods | Gentle focus shift, 50mm, static |
| 13-15 sn | They both continue painting, side by side | Gentle focus shift, 50mm, static |

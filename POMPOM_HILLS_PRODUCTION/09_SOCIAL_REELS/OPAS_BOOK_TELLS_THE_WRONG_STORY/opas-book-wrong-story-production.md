# Opa’s Book Tells the Wrong Story — Production Plan
...
> **Character:** Opa  
> **Location:** Opa’s Tree — Opa’s wide storytelling branch  
> **Dialogue:** None  
> **Music:** None

## Canonical References

- Character identity: `01-CHARACTERS/drawings/opa.png`
- Character canon: `01-CHARACTERS/03-opa.md`
- World reference: `POMPOM_HILLS_PRODUCTION/02_WORLDS/OPA_TREE/01_HERO_VIEW/hero-view.png`
- World canon: `POMPOM_HILLS_PRODUCTION/02_WORLDS/OPA_TREE/00_CANON/06-opas-tree-bible.md`
- Book: one existing rounded storybook with a plain warm-brown cover and no readable text.
...
The second illustration intentionally makes the visual joke coherent: the storybook itself becomes the “reader” and appears to read a tiny picture of Opa. It remains a flat printed illustration, not a living extra character.
...
- Opa and the open book remain inside the centre 60% safe area; use a medium composition so the illustration is readable without oversized props.
- Preserve Opa's green feathers, light-green belly, warm brown eyes, golden round glasses, orange beak and feet, and soft brown shawl.
...
- Quiet Opa's Tree ambience: gentle leaf rustle and very distant birds.
- Soft cover opening, one paper page turn and one tiny glasses adjustment sound.
- No dialogue, narration, extra voices, book voice, music, melody, song or chimes.
...
- [ ] Opa identity, glasses, shawl and colours match approved reference
- [ ] Book design remains fixed and appears only once physically
- [ ] Page 1 shows Opa reading; page 2 shows a printed book reading a tiny printed Opa

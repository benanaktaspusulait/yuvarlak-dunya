...
| Dosya | İçerik |
|---|---|
| `01-overview.md` | Episode lock (Series/Playlist dahil), story summary, scene order, Opening/Closing Bumper, QA Status |
...
| `youtube-metadata.md` | `00-CORE/30_YOUTUBE_METADATA_STANDARD.md` §16 şablonuna göre title/description/tags/hashtag/Shorts |
| `shots/` | 8 shot dosyası (`shot-01-...md` … `shot-08-...md`), Scene QA'dan geçti |

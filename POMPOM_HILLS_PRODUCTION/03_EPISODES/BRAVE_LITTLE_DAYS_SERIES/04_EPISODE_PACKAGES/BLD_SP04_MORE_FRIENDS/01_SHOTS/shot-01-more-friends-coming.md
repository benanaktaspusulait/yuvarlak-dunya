# Brave Little Days — Special Scene 04 — Noah & Arda: More Friends Coming

## Scene Context

- **Video:** Brave Little Days — Special Scenes
- **Shot:** SP04
- **Duration:** 15 seconds
...
Noah and Arda stand together in Central Square. Bridge beat to final full-cast. Noah and Arda feel friends approaching. No extra characters shown. The focus is warm anticipation and eagerness.
...
No extra characters appear even though the dialogue references "friends coming."
...
- any "friend" character mentioned in dialogue but not in approved list
...
### Forbidden props
- any blocks, toys, tools, food, furniture, or new object
...
## Visual Prompt
```text
Use Central Square (world reference) as the LOCKED environment. Insert Noah (character reference) and Arda (character reference) together. Medium shot, warm morning light, Big Pompom Tree softly behind. Noah looks to the side with quiet anticipation, then turns back to viewer with a warm smile. Arda bounces excitedly in place with a tiny in-place body bob, then looks toward viewer with an eager smile. Both stay in place. Both characters are present from the first frame. No props are used. No extra characters appear. No blocks, toys, signs, animals, or extra objects appear. Handcrafted preschool toy-set look, {style} {camera} {lighting}

Only Noah and Arda are present. The focus is warm anticipation — friends are coming but are not yet visible.
...
## Camera Direction
Medium, eye-level, locked composition. No pan, no zoom, no pull-back, no push-in, no tilt, no orbit, no reframe, no camera reveal. Frame Noah and Arda comfortably from the first frame.
...
| 2-5 sn | Noah looks to the side with quiet anticipation | Medium |
| 5-8 sn | Arda bounces excitedly in place with a tiny in-place body bob | Medium |
| 8-12 sn | Noah: "More friends are coming." / Arda: "I can't wait!" | Medium |
| 12-15 sn | Both look toward viewer with eager smiles. Final 0.5s: calm still hold. | Medium |

## Natural Character Motion Rule
Calm but alive: Noah looks to the side with quiet anticipation, then turns back to viewer with a warm smile. Arda bounces excitedly in place with a tiny in-place body bob without changing position, then looks toward viewer with an eager smile. Both stay in place — no walking, no running, no jumping, no repositioning, no crossing, no sudden motion. Both blink naturally.
...
The first frame must already contain the approved character set and approved visible elements for that shot.
...
This shot ends in Central Square and transitions to the final full-cast shot.
...
- [ ] No extra characters appear even though dialogue references "friends coming"
- [ ] Noah looks to the side with quiet anticipation, Arda bounces excitedly in place
- [ ] Both stay in place — no running, no walking, no jumping, no repositioning
- [ ] Prop-free warm anticipation beat reads clearly

# Brave Little Days — Special Scene 03 — Noah & Arda: Big Smile Challenge
...
Noah and Arda stand together in Central Square. Arda tries to make the viewer smile, Noah calmly joins. Very preschool, very safe. No props. The focus is warm and inviting interaction with the viewer.
...
## Visual Prompt
```text
Use Central Square (world reference) as the LOCKED environment. Insert Noah (character reference) and Arda (character reference) together. Medium shot, warm morning light, Big Pompom Tree softly behind. Noah smiles warmly at the viewer with a calm friendly expression. Arda gives a huge enthusiastic grin toward the viewer. Both stay in place. Both characters are present from the first frame. No props are used. No blocks, toys, signs, animals, or extra objects appear. Handcrafted preschool toy-set look, {style} {camera} {lighting}

Only Noah and Arda are present. The focus is warm and inviting interaction with the viewer.
...
| 2-5 sn | Noah: "Ready for a smile?" — warm inviting expression | Medium |
| 5-8 sn | Arda: "Big smile!" — gives a huge enthusiastic grin | Medium |
| 8-12 sn | Both smile warmly at viewer together | Medium |
| 12-15 sn | Calm warm hold with both characters smiling. Final 0.5s: calm still hold. | Medium |

## Natural Character Motion Rule
Calm but alive: Noah smiles warmly at the viewer with a calm friendly expression. Arda gives a huge enthusiastic grin. Both stay in place — no walking, no running, no jumping, no repositioning, no crossing, no sudden motion. No exaggerated expressions, no silly faces, no forced smiles. Both blink naturally.
...
## Negative Prompt
```text
multiple characters, three characters, group, crowd, Kiko, Mimi, Luca, Opa, blocks, building blocks, toys, tools, furniture, food, extra prop, surprise character, character entering later, background crowd, low quality, blurry, deformed, extra limbs, text, watermark, photorealistic, horror, scary, dark lighting, harsh shadows, violence, weapons, sharp objects, redesigned character, wrong scale, character drift, redesigned environment, cluttered background, background music, music, melody, song, soundtrack, musical bed, surprise object, surprise prop, character appearing later, duplicate character, duplicate Noah, duplicate Arda, duplicate body, partial character, shadow character, reflection character, extra animal, toy creature, new object, new prop, object appearing later, object entering later, camera revealing new object, camera revealing new character, jumping, hopping, walking, running, repositioning, crossing, character displacement, bouncing away, exaggerated expressions, silly faces, forced smiles
```
...
This shot ends in Central Square and transitions to SP04 (More Friends Coming).
...
- [ ] Noah smiles warmly, Arda gives a huge enthusiastic grin
- [ ] Both stay in place — no running, no walking, no jumping, no repositioning
- [ ] No exaggerated expressions, no silly faces, no forced smiles
- [ ] Prop-free warm smile beat reads clearly

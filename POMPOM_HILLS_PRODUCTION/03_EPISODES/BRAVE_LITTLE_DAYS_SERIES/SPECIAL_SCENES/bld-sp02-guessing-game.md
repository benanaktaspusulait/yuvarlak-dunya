# Brave Little Days — Special Scene 02 — Noah & Arda: Guessing Game
...
Noah and Arda stand together in Central Square. Noah looks at the viewer like asking a small game question, Arda answers excitedly. No props. The focus is playful and engaging interaction with the viewer.
...
## Natural Character Motion Rule
Calm but alive: Noah looks at the viewer with a playful knowing smile, small head tilt. Arda throws hands up excitedly and answers with joyful energy. Both stay in place — no walking, no running, no jumping, no repositioning, no crossing, no sudden motion. Both blink naturally.

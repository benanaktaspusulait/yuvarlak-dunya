# Why Do Leaves Fall — Shot 04 — Catching Leaf
...
```text
Kiko catches a leaf and smiles. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Gentle focus shift, 50mm, static, no other characters, {style} {camera} {lighting}
...
| 5-7 sn | She holds the leaf up close, examines it | Gentle focus shift, 50mm, static |
| 7-10 sn | She looks at the leaf, then up at the tree it came from | Gentle focus shift, 50mm, static |
| 10-13 sn | She smiles warmly and says her line | Gentle focus shift, 50mm, static |

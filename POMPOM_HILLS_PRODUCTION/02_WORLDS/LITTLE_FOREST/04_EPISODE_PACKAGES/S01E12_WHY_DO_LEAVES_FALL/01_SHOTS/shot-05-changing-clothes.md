# Why Do Leaves Fall — Shot 05 — Changing Clothes
...
Opa uses a metaphor about changing clothes. Kiko's first small smile.
...
```text
Little Forest, warm autumn sunlight. Kiko (coral pink #F8BBD0 shirt, white shorts, brown pigtails) and wise owl Opa (round warm green feathers #A5D6A7, golden glasses #FFD54F, orange beak, soft brown shawl #A1887F) sit together under a big tree. Kiko looks at a fluffy plush Pompom Leaf (soft round cotton-like leaf, autumn gold #FFCC80, no veins, soft edges) with new understanding, a first tiny smile appears on her face. Opa nods warmly. A fluffy plush Pompom Leaf drifts down nearby. The Little Forest background is locked from Shot 04; keep all trees, paths and environment stable. Do not display dialogue as on-screen text. No speech bubbles. No captions. No subtitles. No text. {style} {camera} {lighting}
```
...
```text
Kiko: Like changing clothes?
Opa: Exactly. And in spring, it wears its most beautiful new outfit.
Kiko: Oh...
```
...
- [ ] Background locked from Shot 04
- [ ] No camera movement

# Why Do Leaves Fall — Shot 06 — Dancing Leaves
...
Kiko watches leaves dance in the wind with joy.
...
- [ ] Background locked from Shot 05
- [ ] No camera movement
...
- [ ] Opa visible small/background-only from first frame (continuity from Shot 05)

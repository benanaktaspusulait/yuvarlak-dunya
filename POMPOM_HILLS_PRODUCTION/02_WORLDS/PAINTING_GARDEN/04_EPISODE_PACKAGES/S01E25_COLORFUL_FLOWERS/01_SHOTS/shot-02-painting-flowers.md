# Colorful Flowers — Shot 02 — Painting Flowers
...
```text
She paints them. Kiko joins. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Medium, 50mm, static, no other characters, {style} {camera} {lighting}
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | She paints them. Kiko joins. | Medium, 50mm, static |

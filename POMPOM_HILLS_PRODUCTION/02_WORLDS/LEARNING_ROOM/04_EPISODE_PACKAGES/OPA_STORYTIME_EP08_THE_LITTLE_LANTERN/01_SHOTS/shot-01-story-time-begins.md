# The Little Lantern — Shot 01 — Story Time Begins
...
Maintain all visible background objects throughout the entire video. Do not remove, replace, repaint or transform any visible background object. The rug, story chair, bookshelf, lantern, cushions and arched window remain identical in layout, colour and position. Do not introduce new objects. Do not reinterpret the Reading Corner during the shot.

Only the main characters and the picture book may move.

## Visual Prompt

```text
Use Learning Room Reading Corner (@image1) as LOCKED environment. Insert Opa, Luca and Mimi (@image2/@image3/@image4) into the existing Reading Corner zone. Luca and Mimi sit on the soft rug near Opa's story chair, warm lantern glow filling the cozy corner, gentle evening dusk light through the arched window, Opa holds a rounded picture book with no readable text, wide/medium framing, {style} {camera} {lighting}

Environment is LOCKED and identical to the world reference. Do not redesign the rug, bookshelf, lantern, cushions or window. Keep Learning Room Reading Corner identical in layout, colour and lighting. Evening is soft and cozy, dim but never dark.
...
Wide/medium establishing framing. Lens 28mm, height 0.75m, static.
...
```
Luca: Opa, will you tell us a story?
Mimi: A cozy one?
Opa: Of course. Come close, little friends.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Luca and Mimi settle on the rug near Opa's story chair, warm lantern glow around them. | Wide, 28mm, static |
...
| 5-7 sn | Luca: "Opa, will you tell us a story?" | Wide, 28mm, static |
| 7-10 sn | Mimi leans slightly forward: "A cozy one?" | Wide, 28mm, static |
| 10-12 sn | Opa smiles, nods softly in the lantern glow. | Wide, 28mm, static |
...
Warm lantern glow dominant, soft golden ambient. Gentle evening dusk light through the arched window, soft and dim but cozy. Shadow side lifted, no hard shadows, never dark or scary.
...
The first 3–5 seconds must create curiosity: two children settling into the warm lantern glow near Opa's chair as he lifts a softly glowing rounded book — "what cozy story tonight?"

## QA Checklist

Reference: `16_VIDEO_QA_SPEC.md`, `00-CORE/SCENE_QA_CHECKLIST.md`

- [ ] Character integrity and consistency verified (Opa, Luca, Mimi)
- [ ] Max 3 characters in frame
- [ ] Object persistence verified (rug, chair, shelf, lantern, window)
- [ ] Camera consistency verified (28mm, 0.75m, static)
- [ ] Lighting consistency verified (warm lantern glow, cozy evening — never dark)
...
Children small and childlike within the Reading Corner but readable for expression. Opa=120, Luca=100, Mimi=80 reference scale (`00-CORE/VARIABLES.md`).

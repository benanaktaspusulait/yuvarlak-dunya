# The Tiny Wind That Helped — Shot 09 — Carrying a Little Seed
...
```text
Use Shot 08 video as Video Reference. Slow push-in close-up on book page, a little seed drifting gently to soft warm soil with a soft glow (soft imagination visual, no readable text), Kiko leaning closer with curiosity, warm breezy Reading Corner light unchanged, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 08 reference. Slow push-in on book detail. Lens 50mm, height 0.60m, slow push-in.
...
```
Opa: It carried a little seed to soft, warm soil.
Kiko: So it can grow?
Opa: So it can grow, yes.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold: open book, Kiko close by. | Close-up, 50mm, slow push-in |
| 1-4 sn | Opa: "It carried a little seed to soft, warm soil." | Close-up, 50mm, slow push-in |
| 4-6 sn | A soft glow drifts the seed down onto the soil on the page. | Close-up, 50mm, slow push-in |
| 6-8 sn | Kiko: "So it can grow?" | Close-up, 50mm, slow push-in |
| 8-11 sn | Opa nods warmly. | Close-up, 50mm, slow push-in |
| 11-13 sn | Opa: "So it can grow, yes." | Close-up, 50mm, slow push-in |
| 13-15 sn | Kiko smiles softly at the little seed. | Close-up, 50mm, slow push-in |
...
- Very soft airy whoosh on the seed-drift glow
...
Continue Shot 08 lighting exactly. Warm breezy window light, soft ambient glow. Continue, do not reinterpret.

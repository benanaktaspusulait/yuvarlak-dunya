# The Tiny Wind That Helped — Shot 10 — The Leaf-Boat
...
```text
Use Shot 09 video as Video Reference. Slow push-in close-up on book page, a tiny leaf-boat gliding gently across a small puddle with a soft glow (soft imagination visual, no readable text), Noah watching softly, warm breezy Reading Corner light unchanged, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 09 reference. Slow push-in on book detail. Lens 50mm, height 0.60m, slow push-in.
...
```
Opa: Then it pushed a tiny leaf-boat across a puddle.
Noah: Softly across the water!
Opa: Softly. Just one gentle little push.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold: open book, Noah close by. | Close-up, 50mm, slow push-in |
| 1-4 sn | Opa: "Then it pushed a tiny leaf-boat across a puddle." | Close-up, 50mm, slow push-in |
| 4-6 sn | A soft glow glides the leaf-boat across the puddle on the page. | Close-up, 50mm, slow push-in |
| 6-8 sn | Noah: "Softly across the water!" | Close-up, 50mm, slow push-in |
| 8-11 sn | Opa smiles gently. | Close-up, 50mm, slow push-in |
| 11-13 sn | Opa: "Softly. Just one gentle little push." | Close-up, 50mm, slow push-in |
| 13-15 sn | Noah watches the leaf-boat settle, content. | Close-up, 50mm, slow push-in |
...
- Very soft airy whoosh on the leaf-boat glide glow
...
Continue Shot 09 lighting exactly. Warm breezy window light, soft ambient glow. Continue, do not reinterpret.
...
- [ ] Imagination glow is soft, no sudden flash

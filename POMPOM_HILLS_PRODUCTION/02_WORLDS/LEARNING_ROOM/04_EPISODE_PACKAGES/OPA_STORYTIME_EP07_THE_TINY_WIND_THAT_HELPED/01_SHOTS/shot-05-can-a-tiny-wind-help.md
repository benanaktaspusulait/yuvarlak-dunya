# The Tiny Wind That Helped — Shot 05 — Can a Tiny Wind Help?
...
```text
Use Shot 04 video as Video Reference. Medium two-shot, Kiko tilting her head asking a question, Opa pausing kindly, warm breezy Reading Corner light unchanged, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 04 reference. Static medium two-shot. Lens 35mm, height 0.75m, static.
...
```
Kiko: Can a tiny wind help too?
Opa: Let us see, little one.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold: Kiko and Opa at the open book. | Medium, 35mm, static |
| 1-3 sn | Kiko tilts her head, curious. | Medium, 35mm, static |
| 3-6 sn | Kiko: "Can a tiny wind help too?" | Medium, 35mm, static |
| 6-9 sn | Opa pauses kindly, eyes warm. | Medium, 35mm, static |
| 9-11 sn | Opa: "Let us see, little one." | Medium, 35mm, static |
| 11-13 sn | Kiko brightens, leaning toward the book. | Medium, 35mm, static |
| 13-15 sn | Kiko waits eagerly for the next page. | Medium, 35mm, static |
...
Continue Shot 04 lighting exactly. Warm breezy window light, soft ambient glow. Continue, do not reinterpret.

# The Little Cloud That Waited — Shot 01 — Story Time Begins
...
```text
Use Learning Room Reading Corner (@image1) as LOCKED environment. Insert Opa, Luca and Mimi (@image2/@image3/@image4) into the existing Reading Corner zone. Luca and Mimi sit on the soft rug near Opa's story chair, warm window light, Opa holds a rounded picture book with no readable text, wide/medium framing, {style} {camera} {lighting}
...
```
Luca: Opa, can you read us a story?
Mimi: A gentle one?
...
Warm morning sunlight through the arched window, soft ambient glow. Shadow side lifted, no hard shadows.
...
The first 3–5 seconds must create curiosity: two children hurrying to settle near Opa's chair as he lifts a glowing rounded book — "what story today?"

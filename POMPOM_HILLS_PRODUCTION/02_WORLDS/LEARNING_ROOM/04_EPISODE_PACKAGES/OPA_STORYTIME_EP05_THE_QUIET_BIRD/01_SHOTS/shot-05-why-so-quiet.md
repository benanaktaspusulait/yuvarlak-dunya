# The Quiet Bird — Shot 05 — Why So Quiet?
...
```text
Use Shot 04 video as Video Reference. Medium three-shot, Luca and Mimi both ask questions, Opa answers warmly, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 04 reference. Only after the first frame matches, hold a static medium three-shot. Lens 35mm, height 0.75m, static medium three-shot.
...
```
Luca: Why did she stay so quiet?
Mimi: Maybe she was noticing things?
Opa: That's exactly right, Mimi.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | Luca asks why the bird stayed so quiet. | Medium three-shot, 35mm, static |
| 5-10 sn | Mimi gently offers that maybe she was noticing things. | Medium three-shot, 35mm, static |
| 10-15 sn | Opa warmly confirms Mimi is exactly right. | Medium three-shot, 35mm, static |
...
Continue Shot 04 lighting exactly. Soft diffused rainy-day window light, warm indoor glow, low-contrast. Do not reinterpret — continue it. Never dark or gloomy.

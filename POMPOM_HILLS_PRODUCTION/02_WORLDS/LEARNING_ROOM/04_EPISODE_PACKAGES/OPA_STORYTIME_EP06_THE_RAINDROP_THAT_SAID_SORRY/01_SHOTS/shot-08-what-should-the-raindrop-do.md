# The Raindrop That Said Sorry — Shot 08 — What Should the Raindrop Do?
...
```text
Use Shot 07 video as Video Reference. Medium two-shot of Mimi asking the guiding question, Opa turning it back gently with a warm, encouraging expression, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 07 reference. Hold a static medium two-shot. Lens 35mm, height 0.75m, static.
...
```
Mimi: What should the raindrop do?
Opa: Hmm. What do you think a kind raindrop would do?
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold: Mimi looking at Opa, book between them. | Medium two-shot, 35mm, static |
| 1-4 sn | Mimi: "What should the raindrop do?" | Medium two-shot, 35mm, static |
| 4-6 sn | Opa smiles gently, a thoughtful tilt of his head. | Medium two-shot, 35mm, static |
| 6-10 sn | Opa: "Hmm. What do you think a kind raindrop would do?" | Medium two-shot, 35mm, static |
| 10-12 sn | Mimi looks down at the book, thinking. | Medium two-shot, 35mm, static |
| 12-13 sn | Mimi's small "hmm" expression, finger to her chin. | Medium two-shot, 35mm, static |
| 13-15 sn | Mimi and Opa share a warm, wondering glance. | Medium two-shot, 35mm, static |
...
Continue Shot 07 lighting exactly. Fresh after-rain window light, soft ambient glow. Continue, do not reinterpret.
...
Opa=120, Mimi=80 reference scale (`00-CORE/VARIABLES.md`). Children readable for expression.

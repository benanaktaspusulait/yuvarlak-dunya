# The Raindrop That Said Sorry — Shot 01 — Story Time Begins
...
```text
Use Learning Room Reading Corner (@image1) as LOCKED environment. Insert Opa, Luca and Mimi (@image2/@image3/@image4) into the existing Reading Corner zone. Luca and Mimi sit on the soft rug near Opa's story chair, soft late-afternoon light just after rain with a gentle wet sparkle on the arched window, Opa holds a rounded picture book with no readable text, wide/medium framing, {style} {camera} {lighting}
...
| 1-3 sn | Opa blinks warmly, hands resting on the rounded book in his lap; wet sparkle glints softly on the window. | Wide, 28mm, static |
...
| 7-10 sn | Mimi leans slightly forward: "A soft one?" | Wide, 28mm, static |
...
- Faint last drips off the eaves through the window
...
Soft late-afternoon light just after rain through the arched window, gentle wet sparkle on the glass, warm ambient indoor glow. Shadow side lifted, no hard shadows.
...
The first 3–5 seconds must create curiosity: two children settling near Opa's chair just after the rain as he lifts a glowing rounded book, a fresh sparkle on the window — "what story today?"
...
- [ ] Lighting consistency verified (soft post-rain window light)

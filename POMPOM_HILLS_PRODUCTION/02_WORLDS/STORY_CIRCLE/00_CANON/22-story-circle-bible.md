...
File: POMPOM_HILLS_PRODUCTION/02_WORLDS/STORY_CIRCLE/
Version: 3.1
...
Story Circle, büyük bir hikaye ağacının altında, yuvarlak oturma taşlarıyla çevrili sakin bir mekandır. Opa her akşam burada kitap okur. Çocuklar etrafında oturur, dinler ve hayal kurar.

---

## Purpose

Story Circle, dünyanın en temel geleneği olan hikaye anlatıcılığına adanmış bir mekandır. Büyüyen ağaç ve yuvarlak taşlar, nesiller arası bağ ve bilgelik aktarımını görselleştirir. Sakin atmosfer, izleyiciyi dinlemeye ve düşünmeye davet eder.
...
Hikaye dinlemenin huzurunu ve sıcaklığını temsil eder. Büyüyen ağaç, yuvarlak taşlar ve sıcak ışık — burada her çocuk güvende ve değerli hisseder.

### Çocuklar buraya geldiklerinde nasıl hisseder?

Sakin, güvende, meraklı. "Burada güzel bir hikaye dinleyeceğim."
...
Huzur · Bilgelik · Nesiller arası bağ · Merak · İyi geceler
...
| Özellik | Açıklama |
|---------|----------|
| Open-ended | Hikaye dinleme, hayal kurma, sessizlik |
| Hayal gücü | Hikayelerden dünya kurma |
| İşbirliği | Birlikte dinleme, birlikte hayal etme |
| Gözlem | Yıldız izleme, ağaç izleme |
| Yumuşak hareket | Sessiz oturma, yumuşak dokunuş |
...
**Komşuları:**
- Kuzey: Camping Grove (2 dk)
- Güney: Art Corner (1 dk)
- Doğu: Tree Hill (2 dk)
...
- **Purpose:** Story Circle'a ilk adım
- **Emotional Purpose:** Heyecan — "Hikaye zamanı geldi"
- **Typical Activities:** Yürüyüş, yukarı bakma
- **Lighting:** Doğal, ağaç gölgesi
- **Mood:** Meraklı, sakin
- **Important Props:** Taş yol, ağaç görünümü
- **Camera Usage:** Wide establishing, approach

### Ağaç Altı

- **Purpose:** Ağaç ile ilk temas
- **Emotional Purpose:** Saygı, hayranlık
- **Typical Activities:** Ağaç kabuğuna dokunma, yukarı bakma
- **Lighting:** Gölge, süzülen ışık
- **Mood:** Sessiz, saygılı
- **Important Props:** Ağaç gövdesi, dallar
- **Camera Usage:** Below looking up, medium

### Oturma Alanı

- **Purpose:** Hikaye dinleme bölgesi
- **Emotional Purpose:** Birlikte olma, dinleme
- **Typical Activities:** Taşlarda oturma, hikaye dinleme
- **Lighting:** Sıcak amber, yumuşak
- **Mood:** Sıcak, güvende
- **Important Props:** Yuvarlak taşlar, ağaç gölgesi
- **Camera Usage:** Circle view, medium group

### Merkez (Hikaye Ağacı)

- **Purpose:** Mekanın kalbi — ağaç ve etrafı
- **Emotional Purpose:** Bilgelik, nesiller arası bağ
- **Typical Activities:** Hikaye anlatma, dinleme
- **Lighting:** En sıcak, en yumuşak
- **Mood:** Sıcak, bilge, güvende
- **Important Props:** Büyük ağaç, taşlar
- **Camera Usage:** Wide, medium, close-up
...
|------|----------|----------|:--------:|
| Hikaye ağacı | SC-TREE-01 | Büyük eski ağaç | ✅ |
| Oturma taşları | SC-STONES-01 | Yuvarlak doğal taşlar | ✅ |
| Ağaç gövdesi | SC-TRUNK-01 | Kalın doğal gövde | ✅ |
| Dallar | SC-BRANCH-01 | Geniş yeşil dallar | ✅ |
| Yapraklar | SC-LEAVES-01 | Yeşil yapraklar | ✅ |
| Taş yol | SC-PATH-01 | Doğal taş yolu | ✅ |
| Çimen | SC-GRASS-01 | Yumuşak yeşil çimen | ✅ |
...
| Açı | Kullanım | Not |
|-----|----------|-----|
| Circle view | Etraftan | Taşlar ve ağaç görünür |
| Tree level | Ağaç seviyesi | Yükseklik hissi |
| Below looking up | Aşağıdan yukarı | Büyüklük hissi |
| Close-up | Detay | Ağaç kabuğu, taş |
| Wide | Tüm mekan | Genel manzara |

### Kamera Yüksekliği

- Circle view: 0.85m (taş seviyesi)
- Tree level: 2.00m (dallar)
...
**Camera position:** Etraftan story circle'a bakan geniş açı. Büyük ağaç ve taşlar görünür.
...
**Required props:**
- SC-TREE-01, SC-STONES-01, SC-TRUNK-01, SC-LEAVES-01

**Lighting:** Sıcak amber güneş ışığı. Ağaçtan süzülen. Yumuşak gölge.

**Mood:** Huzurlu, bilge, sıcak.
...
**Purpose:** Story Circle'a giriş.

**Camera position:** Giriş yolundan ağaç altına bakan açı.
...
**Purpose:** Oturma alanının genel görünümü.

**Camera position:** Taşların ortasından.
...
| Tutarlı malzeme | Doğal taş, ahşap, yaprak |
| Tutarlı ölçek | Büyük ağaç, çocuk taşları |
...
- Gürültü varsa reddet
- Hız varsa reddet
- Sivri köşe varsa reddet
- Karanlık varsa reddet
- Yapay ışık varsa reddet
- Ağaç küçük ise reddet
...
| Ses | Kaynak | Ne zaman |
|-----|--------|----------|
| Kuş cıvıltısı | Uzaktan | Sabah/akşam |
| Yaprak hışırtısı | Ağaç | Rüzgarda |
| Rüzgar | Dallar | Her zaman |
| Sessizlik | Genel | Hikaye zamanı |
| Uzak uğultu | Doğa | Gece |
...
| Aksiyon | Frame | Hız |
|---------|-------|-----|
| Gölge değişimi | 30 frame | Çok yavaş |
| Süzülen ışık | 15 frame | Yavaş |
...
6. Sessizce oturulur
7. Ağaç selamlanır
8. Yapraklar toplanır
9. Taşlarda oturulur
10. Gökyüzüne bakılır
11. Rüzgar hissedilir
12. Kuşlar izlenir
13. Ağaç kabuğuna dokunulur
14. Gölgede dinlenilir
15. Sıcak ışık hissedilir
16. Doğa selamlanır
17. Sessizlik paylaşılır
18. Birlikte oturulur
19. Son hikaye dinlenir
20. Gün batımı izlenir
...
- Opa (hikaye anlatan, bilge)
- Tüm çocuklar (dinleyen)
...
- Huzur ve bilgelik
- Nesiller arası bağ
- Dinleme ve hayal gücü
- İyi geceler rutini

### Typical Opening Shots

1. Ağaçtan aşağıya bakış, taşlar görünür
2. Taşların ortasından yukarıya bakış
3. Ağaç gövdesi yakın çekim

### Typical Closing Shots

1. Gün batımı, ağaç silueti
2. Yıldızlar, ağaç altında sessizlik
3. Son ışık, taşlar üzerinde

### Camera Recommendations

| Durum | Lens | Yükseklik | Not |
|-------|------|-----------|-----|
| Genel mekan | 28mm | 0.85m | Ağaç ve taşlar |
| Ağaçtan yukarı | 24mm | 2.00m | Büyüklük |
| Aşağıdan yukarı | 24mm | 0.50m | Heyecan |
| Close-up | 50mm | 0.40m | Ağaç kabuğu, taş |

### Continuity Rules

- Ağaç her zaman büyük ve eski
- Taşlar her zaman yuvarlak
- Işık her zaman sıcak amber
- Ortam her zaman sakin
...
This environment is designed as the canonical storytelling location for PomPom Hills. It will be reused across episodes for story time, evening rituals, wisdom moments, and quiet group gatherings.
...
| Parameter | Value |
|-----------|-------|
| Camera position | Etraftan, hafif aşağıdan |
| Camera height | 0.85m |
| Lens | 28mm |
| Framing | Ağaç %40, taşlar %30, gökyüzü %30 |
| Horizon | Üstte ağaç tacı |
| Lighting direction | Doğal güneş, ağaçtan süzülen |
| Lighting softness | Çok yumuşak, amber |
| Shadow density | %15-20 |
| Colour temperature | 4500K, sıcak amber |
...
| Allowed movements | Gentle pan, slow tilt, circle tracking |
...
| Parameter | Value |
|-----------|-------|
| Primary direction | Doğal güneş, ağaçtan süzülen |
| Softness | Çok yumuşak, amber |
| Ambient fill | Sıcak, doğal |
| Shadow density | %15-20 |
| Exposure | Normal |
| Continuity | Sıcak amber ışık her zaman sabit |
...
| Parameter | Value |
|-----------|-------|
| White balance | 4500K, sıcak amber |
| Exposure | Normal |
| Contrast | Düşük, yumuşak |
| Saturation | Orta, doğal |
| Tree colour | Koyu kahverengi (#5D4037) |
| Stone colour | Doğal gri (#9E9E9E) |
| Leaf colour | Yeşil (#66BB6A) |
| Grass colour | Yeşil (#C8E6C9) |
| Light colour | Amber (#FFB74D) |
| Highlight behaviour | Sıcak, doğal |
| Shadow behaviour | Yumuşak, yeşil tonlu |
| Forbidden colour shifts | Soğuk mavi, koyu siyah, gri |
...
| Wind | Hafif, yaprak |
| Birds | Uzaktan, doğal |
| Ambience level | Çok düşük, sessiz |
| Silence ratio | Çok yüksek — sessizlik baskın |
...
|----------------|-------|----------------------|
| Ağaç boyutu | Büyük, eskin | Hafif varyasyon |
| Taş şekli | Yuvarlak | Boyut farkı |
| Işık rengi | Amber (#FFB74D) | Ton farkı |
...
|---------|---------------|-----|
| Gürültü | Huzur kaybolur | Sessiz ortam |
| Hız | Sakinlik bozulur | Yavaş hareket |
| Sivri köşe | Preschool安全ına aykırı | Yuvarlak taşlar |
| Karanlık | Sıcaklık kaybolur | Sıcak ışık |
| Yapay ışık | Doğallık kaybolur | Doğal ışık |
| Ağaç küçük | Kimlik kaybolur | Büyük ağaç |
...
| Işık değişimi | Çok yavaş, 30 frame |
| Kamera hızı | Maks %2 frame/sn pan veya tilt |
...
Story Circle, PomPom Hills'in hikaye anlatma mekanıdır. Büyük hikaye ağacı, yuvarlak taşlar ve sıcak amber ışıkla tanınır. Hikaye zamanı, akşam rutini ve sessiz grup toplantıları için idealdir. Her üretimde huzur ve sıcaklık hissi korunmalıdır.
...
| Document | Path |
|----------|------|
| World Spec | `POMPOM_HILLS_PRODUCTION/02_WORLDS/STORY_CIRCLE/02_WORLD_SPEC/22-story-circle-world-spec.md` |

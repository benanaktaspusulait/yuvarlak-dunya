...
```text
Kiko joins. They listen together. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Medium, 50mm, static, no other characters, {style} {camera} {lighting}
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | Kiko joins. They listen together. | Medium, 50mm, static |

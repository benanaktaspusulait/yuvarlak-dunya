# The Crystal Cave — Shot 01 — Luca Finds Cave
...
```text
Luca finds a crystal cave. He is nervous. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Wide, 35mm, static, no other characters, {style} {camera} {lighting}

Do not display dialogue as on-screen text. No speech bubbles. No captions. No subtitles. No text.

The Crystal Cave background is locked from the first frame; keep all visible trees, paths, landmarks and environment elements stable throughout the shot.
```
...
First 3-5 seconds: A warm, golden glow emanates from inside a cave entrance. Sparkling reflections dance on the surrounding rocks. Luca and Kiko peer inside with wide eyes.

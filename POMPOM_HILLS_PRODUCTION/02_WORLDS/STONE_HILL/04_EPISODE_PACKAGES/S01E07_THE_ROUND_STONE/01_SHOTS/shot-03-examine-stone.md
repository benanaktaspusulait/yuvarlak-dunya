# E07 — Shot 03 — They Examine the Stone
...
Both characters are already present at the beginning of the shot. Do not introduce a
...
camera moves slowly if planned.
...
Note: the "tiny moon" line is an imaginative comparison only. The actual moon does NOT
need to be visible in the shot.
...
- [ ] Round stone prop remains consistent (round, matte, same size and colour)
...
Include a small emotional moment through facial expression and body language:
wonder, joy, gentle curiosity, shared discovery.

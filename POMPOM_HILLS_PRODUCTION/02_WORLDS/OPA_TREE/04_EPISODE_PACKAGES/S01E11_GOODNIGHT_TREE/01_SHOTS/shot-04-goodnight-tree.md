...
```text
They say goodnight. Arda falls asleep. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars, Medium → Wide, 35mm, slow pull-back, no other characters, {style} {camera} {lighting}
...
```
Arda: Goodnight, tree. / Opa: The tree says goodnight too.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | They say goodnight. Arda falls asleep. | Medium → Wide, 35mm, slow pull-back |
| 5-10 sn | Character interaction | Medium → Wide, 35mm, slow pull-back |
| 10-15 sn | Key moment | Medium → Wide, 35mm, slow pull-back |

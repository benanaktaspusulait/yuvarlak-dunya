# Goodnight Tree — Shot 03 — Tree Sleepy
...
Arda and Opa are at the base of the tree.
...
```text
Arda looks up at the tree and asks if it is sleepy too, Opa smiles warmly, gentle focus shift from Arda to the tree, 50mm, slow push-in, no other characters, {style} {camera} {lighting}
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold — Arda and Opa at base of tree | Medium |
| 1-3 sn | Arda tilts head up toward the tree, eyes curious | Medium |
| 3-5 sn | Arda points gently at the tree above | Medium |
| 5-7 sn | Opa follows Arda's gaze upward, nods slowly | Medium |
| 7-10 sn | Opa turns back to Arda, speaks gently with wing gesture | Medium |
| 10-13 sn | Arda blinks slowly, looks at the tree leaves swaying | Medium |
| 13-15 sn | Arda smiles softly, settles in next to Opa | Medium hold |
...
Warm moonlight with soft evening glow.

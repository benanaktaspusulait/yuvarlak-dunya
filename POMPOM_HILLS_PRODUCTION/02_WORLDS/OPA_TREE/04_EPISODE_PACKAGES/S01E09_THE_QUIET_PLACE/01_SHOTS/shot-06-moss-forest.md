...
Kiko and Opa have been watching the caterpillar together in silence.
...
```text
Kiko notices soft green moss on the tree bark, touches it gently, Opa watches with a warm smile, filtered forest light, round soft shapes, {style} {camera} {lighting}
...
```
Kiko: It's like a tiny forest!
Opa: When we are quiet, we see more.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold — both sitting by the tree, caterpillar still visible | Medium, 50mm, static |
| 1-3 sn | Kiko's gaze drifts to the moss on the bark | Medium, static |
| 3-5 sn | She reaches out gently, touches the soft moss | Medium, static |
| 5-7 sn | Kiko: "It's like a tiny forest!" — fingers tracing the texture | Medium, static |
| 7-9 sn | Opa: "When we are quiet, we see more." — warm, quiet voice | Medium, static |
| 9-11 sn | Kiko looks at Opa, absorbing his words | Medium, static |
| 11-13 sn | Opa: "The forest has secrets for those who wait." | Medium, static |
| 13-15 sn | Both look at the moss together, peaceful — continuity frame | Medium, static |
...
Soft, filtered forest light. Golden beams through leaf canopy, gentle shadows.

...
Opa descends gently from a branch, wings folded, landing softly on the grass near Kiko, warm wise expression, golden glasses #FFD54F glinting. Kiko looks up at Opa with admiration. Warm morning sunlight, soft green leaves.
Opa's Tree — large Pompom Tree, wide branches, soft green canopy #81C784, trunk #A1887F, no other characters, no text, no captions.

Dialogue: Opa: "Shhh... let's listen."
## Voice Lock
...
## Negative Prompt
low quality, blurry, deformed, extra limbs, text, watermark, photorealistic, horror, scary, dark lighting, violence, weapons, sharp objects, extra characters, redesigned tree, redesigned Opa, night sky, moonlight, static talking pose, characters frozen, background music, music, melody, song, soundtrack, high contrast, contrast increase, overly saturated, saturation increase, HDR, HDR look, glossy plastic, glossy CGI, harsh highlights, harsh shadows, blown highlights, oversharpened, extra sharp, over-polished CGI, colour drift, exposure drift, saturation drift, contrast drift, dark areas growing darker, highlights growing brighter, lighting becoming harsher

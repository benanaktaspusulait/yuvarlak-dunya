...
Kiko and Opa watch together as a small butterfly lands nearby, both characters still and peaceful, warm dappled sunlight through leaves, gentle breeze moves grass. Kiko coral pink #F8BBD0, Opa warm green #A5D6A7.
Opa's Tree — large Pompom Tree, wide branches, soft green canopy, trunk, no other characters, no text, no captions.

Dialogue: (no dialogue — quiet observation)
## Voice Lock

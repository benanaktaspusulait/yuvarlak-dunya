# The Sleepy Leaf — Shot 05 — The Leaf Won't Stop
...
```text
Use Shot 04 video as Video Reference. Medium shot, Opa describes the leaf going faster and faster, Kiko wonders what happens next, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 04 reference. Hold a static medium. Lens 50mm, height 0.85m, static medium.
...
```
Opa: It kept going, faster and faster.
Kiko: But what happened next?
```
...
Continue Shot 04 lighting exactly. Warm golden-hour sunset light, long soft shadows, warm ambient glow. Continue, do not reinterpret.

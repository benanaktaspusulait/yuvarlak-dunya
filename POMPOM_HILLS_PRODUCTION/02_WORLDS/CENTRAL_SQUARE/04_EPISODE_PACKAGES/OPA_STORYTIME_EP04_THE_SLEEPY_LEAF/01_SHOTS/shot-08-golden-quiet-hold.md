# The Sleepy Leaf — Shot 08 — Golden Quiet Hold
...
```text
Use Shot 07 video as Video Reference. Slow pull-back to wide golden warm hold on the story blanket, group settles quietly, quiet hold for 2 seconds, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 07 reference. Slow pull-back to a wide golden hold. Lens 35mm, height 0.85m, slow pull-back to wide hold (stays inside the existing scene — no new establishing shot). Final 2 seconds held static. No abrupt cut to black.
...
| Time | Action | Camera |
|---|---|---|
| 0-6 sn | Slow pull-back as the group settles quietly on the blanket. | Pull-back, 35mm |
| 6-13 sn | Opa, Kiko and Noah rest together in the warm sunset glow. | Wide, 35mm, settle |
| 13-15 sn | Quiet golden hold, no dialogue. | Wide, 35mm, static |
...
- Very gentle breeze settling
- Warm golden-hour ambience fading softly (episode music tail added in edit)

---

## Lighting

Continue Shot 07 lighting exactly. Warm golden-hour sunset light, long soft shadows, warm ambient glow. Continue, do not reinterpret.
...
low quality, blurry, deformed, extra limbs, text, watermark, photorealistic, horror, scary, dark lighting, violence, weapons, sharp objects, extra characters, redesigned environment, different tree, market stalls, modern street furniture, adult lecture feeling, abrupt cut to black

...
- Central Square open grass play area.
- Big Pompom Tree visible in the background.
- Luca and Noah are already in frame near the same round yellow ball.
- The yellow ball sits on the grass in front of them.
- Warm morning light.
- No extra characters.
...
Use a stable wide-to-medium settle only.
Do not change background layout.
Keep visible benches and Big Pompom Tree stable.
...
Continuity Reference: This is the first shot. Use approved original first-frame still.
...
Voice: Luca and Noah voices established here.

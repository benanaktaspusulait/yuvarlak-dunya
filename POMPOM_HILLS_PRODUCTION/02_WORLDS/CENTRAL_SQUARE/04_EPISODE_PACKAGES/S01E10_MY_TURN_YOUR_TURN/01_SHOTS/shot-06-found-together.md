...
Continuity reference: previous shot video reference or exported final frame from Shot 05.
...
- Same Central Square area reached by the ball in Shot 05.
- The ball stops beside an existing shrub already belonging to Central Square.
- Do not create a new bush, new garden, new forest, new path or new location.
- Big Pompom Tree remains visible in the background when composition allows.
- Luca and Noah find the same yellow ball together.
- Warm morning light remains identical to the Episode Colour Master.
...
The shrub is an existing Central Square shrub, not a new location or new environment.
...
The shrub is an existing Central Square shrub; do not create a new garden, forest, or different area.
...
Use wide-to-medium gentle settle.
The existing shrub must already belong to Central Square.
Do not create a new location.
Do not replace benches, tree, path or background houses.

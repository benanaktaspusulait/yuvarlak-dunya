...
- Tree size in frame
- Visible path layout
- Visible stepping stones
- Visible benches
- Visible planter
- Visible bunting
- Visible houses
- Visible sky proportion
- All visible background object positions
...
1. First-frame match
2. No camera pull-back
3. No new object reveal
4. Kiko entrance clarity

---

## Background Object Lock

The first frame defines the physical Central Square set. The Big Pompom Tree, rounded
paths, stepping-stone ring, grass, benches, planters and distant houses remain stable
throughout the shot.
...
- Delayed Character Introduction Rule
...
Do not place Kiko inside flowers, bushes, planter edges or dense grass. Kiko may point, turn, smile or take one tiny step only. Kiko must not walk behind the red planter, bunting, bushes, flowers, tree trunk, bench or foreground grass.
...
Kiko's speaking voice is established here for this episode. Maintain the same voice
identity, pitch, timbre, warmth, pronunciation, accent, speaking speed and recording
quality in all later Kiko lines.
...
Kiko should feel small and childlike within Central Square, occupying about 6-8% of the
frame while remaining readable.

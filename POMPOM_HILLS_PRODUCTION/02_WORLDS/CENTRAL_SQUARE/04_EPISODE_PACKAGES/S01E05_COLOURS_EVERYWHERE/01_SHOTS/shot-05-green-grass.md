...
This shot continues directly from Shot 04.

Kiko and Mimi are already present in the same Central Square set. They notice a soft
green grass patch beside the rounded paving stones.
...
soft carpet-like green grass, pastel bench, flower planters, warm morning daylight.

---

## Environment Anchors

- Same physical Central Square area from Shot 04.
- Big Pompom Tree remains the main background landmark.
- Green grass patch and rounded paving stones were seeded in the Central Square set and
  preserved through the previous continuity frames, beside the same rounded
  path/paving stones.
- Central Square identity stays clear through the Big Pompom Tree, rounded paths,
  stepping-stone ring, benches and planters.
- Kiko and Mimi stay together in the same local area.
- No new field, meadow or alternate world appears.

---

## Start Frame

Start from the approved exported final continuity frame from Shot 04. Preserve the
...
Do not turn Central Square into a meadow, field, Flower Hill or nature world. Keep the
Central Square identity clear.
...
The green grass patch must remain part of Central Square beside the rounded paving
stones. Kiko and Mimi may look down and take only tiny steps beside the grass patch.
They must not enter dense grass, sink into grass, disappear into grass, become hidden by
foreground plants or turn the square into a meadow. Keep paths and stepping stones
visible throughout.
...
```text
Kiko and Mimi already together in the same Central Square area, noticing a soft green grass patch beside the rounded paving stones, Big Pompom Tree in background, coloured stepping-stone ring, benches and existing planters stable so the Central Square identity stays clear, warm morning daylight, gentle playful mood, no other characters, {style} {camera} {lighting}

Use @image1 as the starting continuity frame from Shot 04.

Preserve Kiko, Mimi, the same Central Square layout, Big Pompom Tree, rounded paths, stepping-stone ring, existing planters, camera position, lighting and Episode Colour Master from @image1.
...
Square layout, lighting, camera position, Kiko and Mimi appearances, grass/paving
relationship and Episode Colour Master.

---

## Camera Direction

Begin from the Shot 04 continuity frame with no camera reset. The first 1 second should visually hold close to @image1 before new action begins. After that, the grass patch
becomes the action focus.

Use a stable child-eye-level medium-wide frame. Keep both characters visible. Do not
introduce new characters, new landmarks, new paths, roads, shops, fountains, water
features, meadows or a different Central Square area.

Keep Central Square readable through the Big Pompom Tree, rounded paths,
stepping-stone ring, benches and planters.
...
@image1 must be the approved final continuity frame of Shot 04.
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | First second holds near Shot 04 frame; Mimi notices the grass | Medium-wide |
| 5-10 sn | Both look down gently at the green grass patch | Stable |
| 10-15 sn | Kiko smiles and names the feeling | Medium-wide hold |
...
- Soft grass rustle
- Quiet Central Square ambience
- Gentle footstep on rounded path
...
- [ ] The first 1 second visually holds close to `@image1` before the green grass discovery begins.
- [ ] Both Kiko and Mimi remain visible and consistent.
- [ ] Green grass patch and rounded paving stones were seeded in the Central Square set and preserved through the previous continuity frames.
- [ ] Central Square does not become a meadow, field, Flower Hill, nature world or alternate world.

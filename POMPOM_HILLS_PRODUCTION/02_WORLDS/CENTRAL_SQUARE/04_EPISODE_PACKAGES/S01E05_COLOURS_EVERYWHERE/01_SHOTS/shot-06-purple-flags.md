...
Kiko and Mimi are already present in the same Central Square set. They notice small
soft purple bunting or flags already established in the same set.
...
soft grass, pastel bench, flower planters, soft bunting if already visible, warm morning
daylight.
...
Start from the approved exported final continuity frame from Shot 05. Preserve the
...
Do not add signs, readable text, a stage, a crowd or a different celebration setup.
...
Purple flags or bunting must stay fixed in the same place. Kiko and Mimi may look up,
point and make small body turns, but they should not walk across the set. They must not
pass behind bushes, flags, planters, trees, benches or foreground plants. No festival
setup, no stage and no crowd.


## Visual Prompt

```text
Kiko and Mimi already together in the same Central Square area, noticing small soft purple bunting or flags already established in the same Central Square set, Big Pompom Tree in background, rounded paths, coloured stepping-stone ring and soft green grass stable, warm morning daylight, gentle joyful discovery, no other characters, {style} {camera} {lighting}

Use @image1 as the starting continuity frame from Shot 05.

Preserve Kiko, Mimi, the same Central Square layout, Big Pompom Tree, rounded paths, stepping-stone ring, purple bunting or flags, camera position, lighting and Episode Colour Master from @image1.
...
Square layout, lighting, camera position, Kiko and Mimi appearances, purple bunting or
flags and Episode Colour Master.

---

## Camera Direction

Begin from the Shot 05 continuity frame with no camera reset. The first 1 second should visually hold close to @image1 before new action begins. After that, the purple flags
...
features, stages, signs or a different Central Square area.

Do not turn this into a festival, stage, readable sign, crowd, celebration setup or
alternate location.
...
| Time | Action | Camera |
|---|---|---|
| 0-5 sn | First second holds near Shot 05 frame; Kiko spots purple bunting | Medium-wide |
| 5-10 sn | Both look up gently at the purple flags | Stable |
| 10-15 sn | Mimi reacts to the many colours | Medium-wide hold |

---

## Sound

- Soft bunting flutter
- Light breeze through the Big Pompom Tree
- Warm colour-discovery chime

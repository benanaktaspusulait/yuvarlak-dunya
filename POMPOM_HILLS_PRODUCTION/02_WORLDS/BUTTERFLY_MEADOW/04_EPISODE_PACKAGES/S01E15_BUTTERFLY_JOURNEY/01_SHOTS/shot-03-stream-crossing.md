...
| Shot | 03 / 12 |
| Duration | 15 seconds |
| Location | Butterfly Meadow — stream edge |
...
Previous shot: They followed the butterfly through tall flowers. It changed direction.

The butterfly flies over a small gentle stream. They need to cross.
...
Luca and Kiko at the edge of a small gentle stream. Smooth stepping stones cross the water. The butterfly is on the other side. Luca steps onto the first stone carefully. Kiko watches. Butterfly Meadow — stream, stepping stones, flowers on both sides, sunny day. Wide, 35mm, static, no other characters, {style} {camera} {lighting}

Do not display dialogue as on-screen text. No speech bubbles. No captions. No subtitles. No text.

The Butterfly Meadow background is locked from the first frame; keep all visible stream, stones, flowers and environment elements stable throughout the shot.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-3 sn | First frame matches. They arrive at the stream edge. | Wide, 35mm, static |
| 3-7 sn | Luca looks at the stepping stones. Points across. | Wide, 35mm, static |
| 7-10 sn | Luca steps carefully onto the first stone. | Wide, 35mm, static |
| 10-13 sn | He hops to the next stone. Kiko follows. | Wide, 35mm, static |
| 13-15 sn | They reach the other side. Butterfly waits. | Wide, 35mm, static |
...
- Gentle stream water flowing
- Soft splash as they step on stones
- Wing flutter from across the stream
- Birds singing

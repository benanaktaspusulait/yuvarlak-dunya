# Music Trees — Shot 07 — The Hollow Tree
...
Previous shot: They tapped different trees, creating sounds.

Noah finds a big hollow tree with a deep sound.
...
Noah finds a big round hollow tree. He taps it — a deep "boom" sound! Arda's eyes widen. Noah taps again — "Boom boom!" Music Hill — big hollow tree, warm afternoon light. Medium, 50mm, static, {style} {camera} {lighting}
...
| Time | Action | Camera |
|---|---|---|
| 0-3 sn | First frame matches. Noah approaches the hollow tree. | Medium, 50mm, static |
| 3-7 sn | He taps it — deep "boom!" | Medium, 50mm, static |
| 7-10 sn | Arda's eyes widen. Noah taps again — "Boom boom!" | Medium, 50mm, static |
| 10-13 sn | Arda taps it too, feeling the vibration | Medium, 50mm, static |
| 13-15 sn | They both tap together — "Boom boom boom!" | Medium, 50mm, static |

---

## Sound

- Deep hollow "boom" sounds
- Tree vibration

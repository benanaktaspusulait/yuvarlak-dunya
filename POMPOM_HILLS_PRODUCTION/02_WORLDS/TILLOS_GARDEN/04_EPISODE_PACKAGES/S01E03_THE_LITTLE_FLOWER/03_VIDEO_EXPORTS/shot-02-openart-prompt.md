...
Kiko plants and waters. Mimi helps. in Pompom Hills, warm pastel colors, round soft shapes, night sky with stars. Kiko coral pink #F8BBD0 shirt, white shorts, brown pigtails, focused expression. Mimi soft blue #90CAF9 shirt, round ears, helpful look.
Tillo's Garden — flower beds, garden paths, trees, no other characters, no text, no captions.

Dialogue: Kiko: "Water, water, grow!" / Mimi: "I'll help!"
## Negative Prompt
...
## OpenArt Ayarları
- Duration: 15 seconds
- @image1: Tillo's Garden — flower beds, garden paths, trees

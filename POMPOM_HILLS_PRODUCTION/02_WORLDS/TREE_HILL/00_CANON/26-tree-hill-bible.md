...
File: POMPOM_HILLS_PRODUCTION/02_WORLDS/TREE_HILL/
Version: 3.1
...
Tree Hill, sessiz orman tepesi.

Birçok eski ağaç var.

Kamp ve kamp ateşi mekanı.

Sakinlik ve huzur hissi.
...
Full tree hill panorama with ancient round-crowned trees. Deep green canopy (#66BB6A) with golden light filtering through. Calm, wise atmosphere of old forest. Multiple tree sizes creating natural cathedral effect. No characters present.

### Reference 02 — Entrance View

Tree hill entrance with largest ancient tree as gateway. Path leading upward between thick trunks. Dappled light creating safe passage. Round shapes dominant in bark and branches. Child-friendly perspective looking up.

### Reference 03 — Trail View (mid-environment)

View through tree trunks looking across hilltop. Multiple ancient trees in middle distance. Soft ground cover of moss and fallen leaves. Warm light creating peaceful atmosphere. Depth through layered tree trunks.

### Reference 04 — Detail View

Close-up of ancient tree bark texture with moss. Round growth rings visible on cut stump. Tiny forest floor details (mushrooms, acorns). Macro perspective showing age and wisdom. Soft natural forest lighting.

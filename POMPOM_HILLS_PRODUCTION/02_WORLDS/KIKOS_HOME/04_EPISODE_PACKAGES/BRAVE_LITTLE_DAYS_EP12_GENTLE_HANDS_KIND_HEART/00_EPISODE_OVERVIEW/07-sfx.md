...
| Time | SFX | Description |
|------|-----|-------------|
| 0:15–0:17 | Quick footstep | Kiko leaning forward eagerly |
| 0:17–0:20 | Fabric rustle | Quick movement, coral top rustling |
| 0:20–0:25 | Excited breath | Kiko's eager inhalation |
| 0:25–0:30 | Garden ambience | Continued background |

### Shot 03 — "Soft and Gentle"
| Time | SFX | Description |
|------|-----|-------------|
| 0:30–0:33 | Soft paw placement | Mimi stepping in gently |
| 0:33–0:38 | Calm movement | Mimi's slow, calming gesture |
| 0:38–0:45 | Garden ambience | Warm, safe atmosphere |

### Shot 04 — "One Gentle Finger"
| Time | SFX | Description |
|------|-----|-------------|
| 0:45–0:50 | Near-silence | Garden ambience drops very low |
| 0:50–0:55 | Soft breath | Kiko's careful, slow breathing |
| 0:55–0:58 | Tiny wing twitch | Butterfly's wings adjusting |
| 0:58–1:00 | Suspended silence | Maximum tension — hold |
...
| Time | SFX | Description |
|------|-----|-------------|
| 1:15–1:18 | Warm breath | Mimi's happy exhalation |
| 1:18–1:25 | Whispered wonder | Kiko's soft words |
| 1:25–1:30 | Garden ambience returns | Warm, gentle — life continues beautifully |
...
| Principle | Rule |
|-----------|------|
| Butterfly sound | Always soft, delicate, pastel-feeling. Never buzzing or insect-like |
| Character breath | Natural, age-appropriate. No exaggerated breathing |
| Silence | Used deliberately in Shots 01, 04, 05 for tension and wonder |
| Volume arc | Gentle throughout. Peaks only at Kiko's gasp (Shot 05) |
| Garden ambience | Constant thread. Drops low in tense moments, returns in relief |
| Emotional sfx | No overtly "emotional" sounds. Let visuals carry feeling |
...
```
Shot 01: Light ambience → silence of discovery
...
| Character | Quality | Processing |
|-----------|---------|------------|
| Kiko | Young child, bright → whispered | No effects. Natural, clean |
| Mimi | Warm, honey-toned, calm | No effects. Natural, clean |
| Both | Intimate, close-mic feeling | As if recorded in a quiet garden |

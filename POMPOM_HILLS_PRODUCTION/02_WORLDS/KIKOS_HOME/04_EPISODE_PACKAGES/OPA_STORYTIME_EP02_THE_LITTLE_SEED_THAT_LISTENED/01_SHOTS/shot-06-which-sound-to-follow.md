# The Little Seed That Listened — Shot 06 — Which Sound to Follow
...
```text
Use Shot 05 video as Video Reference. Medium shot, Kiko asks her question, Opa pauses kindly, Mimi listens, warm Kiko's Home light unchanged, {style} {camera} {lighting}
...
```
Kiko: Which sound should it follow?
Opa: It listened to all of them, gently.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold; Kiko, Opa, Mimi around the book. | Medium, 35mm, static |
| 1-3 sn | Kiko: "Which sound should it follow?" — she gestures toward the page. | Medium, 35mm, static |
| 3-5 sn | Opa pauses, looks at both children. | Medium, 35mm, static |
| 5-7 sn | Opa: "It listened to all of them, gently." — he nods softly. | Medium, 35mm, static |
| 7-10 sn | Mimi tilts her head, thinking. | Medium, 35mm, static |
| 10-12 sn | Kiko blinks, absorbing the answer. | Medium, 35mm, static |
| 12-15 sn | Opa smiles; the children share a quiet glance. | Medium, 35mm, static |
...
- [ ] Voice continuity verified (Opa, Kiko, Mimi)
...
Opa=120, Mimi=80, Kiko=100 reference scale (`00-CORE/VARIABLES.md`).

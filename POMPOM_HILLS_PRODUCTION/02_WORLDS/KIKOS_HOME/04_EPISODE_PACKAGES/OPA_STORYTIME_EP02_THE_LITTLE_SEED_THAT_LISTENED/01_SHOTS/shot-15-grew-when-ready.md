# The Little Seed That Listened — Shot 15 — Grew When Ready
...
```text
Use Shot 14 video as Video Reference. Medium shot, Opa gives the gentle lesson, Kiko listens thoughtfully, warm Kiko's Home light unchanged, {style} {camera} {lighting}
...
```
Opa: The seed grew when it was ready.
Mimi: Listening helped it grow.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold; Opa and Mimi by the book. | Medium, 35mm, static |
| 1-3 sn | Opa: "The seed grew when it was ready." — he gestures gently. | Medium, 35mm, static |
| 3-5 sn | Mimi looks at the page, processing the lesson. | Medium, 35mm, static |
| 5-7 sn | Mimi: "Listening helped it grow." — she nods softly. | Medium, 35mm, static |
| 7-10 sn | Opa smiles warmly at Mimi's understanding. | Medium, 35mm, static |
| 10-12 sn | Mimi blinks, looking at the book illustration. | Medium, 35mm, static |
| 12-15 sn | Opa holds the page open; both gaze at it. | Medium, 35mm, static |
...
Continue Shot 14 lighting exactly.

---

## Reference Usage

- Continuity Reference: Shot 14 video
...
Opa=120, Mimi=80 reference scale.

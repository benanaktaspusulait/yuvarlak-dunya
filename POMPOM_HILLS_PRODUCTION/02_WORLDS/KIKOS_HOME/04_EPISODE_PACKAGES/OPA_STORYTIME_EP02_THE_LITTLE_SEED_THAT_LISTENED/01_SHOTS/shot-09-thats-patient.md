# The Little Seed That Listened — Shot 09 — That's Patient
...
```text
Use Shot 08 video as Video Reference. Medium shot, Opa continues, Kiko reflects on patience, warm Kiko's Home light unchanged, {style} {camera} {lighting}
...
Begin from the identical camera position of the Shot 08 reference. Static medium. Lens 35mm, height 0.75m, static.
...
```
Opa: Yes. Listening is waiting, too.
Kiko: I can be patient.
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold; Opa and Kiko by the book. | Medium, 35mm, static |
| 1-3 sn | Opa: "Yes. Listening is waiting, too." — he nods gently. | Medium, 35mm, static |
| 3-5 sn | Kiko looks down at the page thoughtfully. | Medium, 35mm, static |
| 5-7 sn | Kiko: "I can be patient." — she sits up straighter. | Medium, 35mm, static |
| 7-10 sn | Opa looks at Kiko warmly, smile softens. | Medium, 35mm, static |
| 10-12 sn | Kiko blinks, breathing softly. | Medium, 35mm, static |
| 12-15 sn | Opa holds the page open; both gaze at the book. | Medium, 35mm, static |
...
Continue Shot 08 lighting exactly.

---

## Reference Usage

- Continuity Reference: Shot 08 video
...
Opa=120, Kiko=100 reference scale.

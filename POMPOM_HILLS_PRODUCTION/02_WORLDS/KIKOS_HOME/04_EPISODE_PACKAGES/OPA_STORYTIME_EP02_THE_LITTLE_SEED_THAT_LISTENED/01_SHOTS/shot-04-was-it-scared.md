# The Little Seed That Listened — Shot 04 — Was It Scared?
...
```text
Use Shot 03 video as Video Reference. Medium shot, Opa continues the story gently, Kiko listens with concern, warm Kiko's Home light unchanged, {style} {camera} {lighting}
...
```
Opa: A little. But it wasn't alone.
Kiko: Who was with it?
```
...
| Time | Action | Camera |
|---|---|---|
| 0-1 sn | Continuity hold; Opa and Kiko by the open book. | Medium, 35mm, static |
| 1-3 sn | Opa: "A little. But it wasn't alone." — he looks at Kiko gently. | Medium, 35mm, static |
| 3-5 sn | Kiko blinks, processing the answer. | Medium, 35mm, static |
| 5-7 sn | Kiko: "Who was with it?" — she leans slightly forward. | Medium, 35mm, static |
| 7-10 sn | Opa smiles warmly, holds the page open. | Medium, 35mm, static |
| 10-12 sn | Opa glances down at the book illustration. | Medium, 35mm, static |
| 12-15 sn | Kiko waits patiently, breathing softly. | Medium, 35mm, static |
...
Opa=120, Kiko=100 reference scale (`00-CORE/VARIABLES.md`).

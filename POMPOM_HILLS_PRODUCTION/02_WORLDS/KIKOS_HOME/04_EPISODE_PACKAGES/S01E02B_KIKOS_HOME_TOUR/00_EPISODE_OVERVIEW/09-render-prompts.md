# Render Prompts — Kiko's Home Tour

> **15 saniye. 4 shot. Dışarıdan içeriye kesintisiz.**

---

## Global Style

All shots use this base style:
...
Do NOT wave hello.
Do NOT introduce the house again.
Continue naturally from the current moment.
...
After passing through the doorway, remain inside the same house.

Use the existing Kiko Home World.
Do NOT redesign the environment.

The first interior view should reveal a warm open preschool living space.
...
Use exactly the same Kiko Home world.

Do not regenerate another house.
...
Use the existing Kiko character exactly.
...
No repeated waving.
No repeated house presentation.
No world regeneration.
...
- Shot 01: First shot — no @image1 (visual continuity with S01E01 through identical world)
- Shot 02: @image1 = Shot 01 last frame
- Shot 03: @image1 = Shot 02 last frame (interior)
- Shot 04: @image1 = Shot 03 last frame
- All 4 shots use the SAME world reference
- Lighting must be IDENTICAL across all 4 shots

---

*Bu render prompt'ları 15 saniyelik bölümün tamamını kapsar.*

# BLD-EP06 — Shot 08 — Goodnight

## Scene Lock

- Duration: exactly 15 seconds, horizontal 16:9.
- Use the approved Shot 07 final frame as the only `@image1`.
- Kiko starts and remains with eyes closed throughout the entire shot.
- Mimi starts with eyes open, looking at Kiko (as seen in `@image1`).
- Mimi’s mouth moves only during her own lines and closes after each line.
- Mimi makes one slow final eye closure between 13.8s and 14.6s and does not reopen them.
- Mimi’s two paws remain resting in their exact @image1 positions on the blanket.
- The blue fuzzy Pompom Ball remains at Kiko’s outer side, visible, away from Mimi and stationary.
- Kiko’s legs and feet remain hidden under the blanket; blanket does not move.
- Kiko’s two hands remain resting on the same blanket edge.
- Use "wooden single bed" for all bed references.
- Preserve the exact approved warm dusk light from @image1; no "blue-lavender night".
- No closing bumper, end card, moon, stars or music.

## OpenArt Setup

- Seedance Frame-to-Video, 15 seconds.
- Auto Voice OFF; saved Kiko and Mimi voices selected manually.
- Prompt Enhancer OFF; Cinematic/Auto Camera OFF; music OFF.
- Fixed child-eye 32mm camera.
...
Maximum line speed: **2.38 words/second**. Maximum interval without dialogue, breathing or purposeful action: **0.8 second**.
...
- Kiko and Mimi are seated on the same wooden single bed.
- Both characters have their eyes and mouths closed.
- Mimi’s two paws remain resting in their exact @image1 positions on the blanket.
- Kiko’s two hands remain resting on the same blanket edge.
- Kiko’s legs and feet are completely hidden under the blanket.
- The blanket stays tucked below Kiko’s shoulders.
- The blue fuzzy Pompom Ball is stationary at Kiko’s outer side and visible.
- Camera, warm dusk light, room tone and matte quality are fixed.
- Tiny natural breathing movement continues.
- The shot ends naturally with no bumper or text.

## Approval Checklist

- [ ] Kiko starts and stays with eyes closed throughout the shot.
- [ ] Mimi starts with eyes open and looking at Kiko (matching @image1).
- [ ] Mimi makes one slow final eye closure (13.8-14.6s) and stays closed.
- [ ] Mimi’s two paws remain resting in their exact @image1 positions on the blanket.
- [ ] Blue fuzzy Pompom Ball is present, stationary, and on the outer side.
...
End directly on the approved Shot 08 final frame. Do not append the retired Brave Little Days opening/closing bumper workflow.

...
No other character appears yet.
...
After the Take Shot is approved, remove all three and use only the approved Take Shot as `@image1` for the video.
...
```text
Create a horizontal 16:9 static opening frame for EP09 — Share the Sunshine.

Use @image1 only for the established Kiko's Home living/play area, room architecture, furniture layout, rug, warm daylight direction and approved preschool environment.

Use @image2 only for canonical Kiko identity.

Kiko must exactly preserve her approved character design:

young preschool girl,
canonical Kiko face,
large warm brown eyes,
brown hair in two rounded buns,
coral-pink hair ties,
coral-pink long-sleeve top,
white shorts,
coral-pink shoes,
canonical child body proportions.

Preserve canonical Kiko body scale.
Do not make Kiko taller, smaller, older, thinner or more baby-like than her approved reference.

Use @image3 only for exactly ONE child-safe soft pastel-blue ball.
...
pastel light blue,
child-hand sized,
approximately 12 cm diameter relative to Kiko,
subtle simple surface pattern if present in the approved reference,
no face,
no eyes,
no writing,
no logo.
...
She holds exactly one pastel-blue ball naturally with both hands just above her lap.

Both hands are fully visible and anatomically clean.

The ball is completely separate from her fingers and body.

Kiko has bright attentive eyes and one small delighted CLOSED-MOUTH smile.
...
approximately 30 mm natural preschool framing,
medium-wide composition,
Kiko and ball clearly readable,
no extreme close-up,
...
matte handcrafted toy-set feeling,
medium-low contrast,
...
Kiko's mouth must be fully closed.
```
...
Do not reconstruct the opening.
...
# CRITICAL BALL CONTINUITY LOCK

Exactly **ONE ball** exists for the entire 15-second shot.

It is always the SAME pastel-blue ball.
...
There is exactly **ONE completed mini toss**.

No second completed toss.

---

# CRITICAL SPEECH PACING LOCK

Speak all lines at a natural, playful preschool pace.
...
simplify a small gesture instead of increasing speech speed.
...
The complete soundtrack contains only:

1. Kiko's exact scripted dialogue
2. extremely faint natural non-musical indoor room tone
3. extremely subtle soft ball-hand contact if naturally necessary
...
0.0–0.3:
Kiko's eyes move toward the ball.
She gives the existing ball one tiny playful lift with both hands.
...
1.7–2.1:
Kiko makes one tiny grip adjustment while keeping both hands clean and visible.
...
3.0–3.4:
The SAME ball begins rising only a short distance above Kiko's hands.
...
4.5–5.1:
The SAME ball falls directly back toward Kiko's hands.
...
6.0–6.5:
Kiko gently brings the same ball closer to herself.
...
DO NOT complete another toss.

9.3–10.1:
Kiko rotates the same ball slightly between her hands and keeps playing actively.
...
The ball remains completely in her hands.

No second toss.

11.4–12.0:
Kiko pauses the preparation because her attention begins shifting toward something offscreen-right.

This is a motivated reaction, not a blank pause.
...
13.4–14.1:
Kiko keeps the ball safely in both hands while listening toward screen-right.

Her mouth closes completely after her line.

14.1–15.0:
Kiko's head and eyes continue naturally orienting toward screen-right.

She gives one small curious closed-mouth smile while still holding the ball securely.

Do not introduce Arda yet.

End during the active rightward attention shift.

PURPOSEFUL MOTION THROUGHOUT:
...
→ clean catch
→ brief cuddle
→ second-play preparation
→ small ball rotation
→ interrupted preparation
→ offscreen-right curiosity.

No blank staring.

No idle dead-air hold.

No static section longer than 1 second.

Exactly one ball throughout.
...
Preserve @image1's exact warm pastel visual quality.

Do not increase contrast.
Do not increase saturation.
Do not increase sharpness.
Do not increase HDR.
Do not add glossy highlights.

If any visual correction occurs, make the image slightly softer and calmer, never stronger.
...
There is no long speechless tail.
...
Dialogue remains slow enough for preschool comprehension.
...
Only extremely faint natural room tone.
...
# CONTINUITY INTO SHOT 02

Shot 02 must use the **actual approved Shot 01 final frame only** as visual continuity source.
...
Shot 02 must be adjusted to that actual frame before rendering.

Canonical Arda should then be supplied separately only as his identity reference for his first entrance.

# S01E02 — Bounce, Bounce, Kiko! Detaylı Anlatım
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=15/Z=5, yerde)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (Kiko'nun elinde)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=10→20, yuvarlanıyor)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=10/Z=0, yerde)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=5/Z=0, yerde)

---

### Sahne 07 — Kelebekler (90-105 sn)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=5/Z=0, yerde), `03-PROPS/Nature/1-butterflies.png`
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=5→10, zıplıyor)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=15→25, yuvarlanıyor, kadrajda)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=25→30, yavaşlıyor)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=30/Z=0, yerde)
...
**Asset:** `03-PROPS/Toys/1-yellow-ball.png` (X=15/Z=0, ikisinin arasında)
...
|---|---|---|
| Yellow Ball | `03-PROPS/Toys/1-yellow-ball.png` | 11 sahne |
| Butterflies | `03-PROPS/Nature/1-butterflies.png` | 1 sahne |
| Flowers | `03-PROPS/Nature/2-flowers.png` | 1 sahne |
| Kiko's Home | `environment/03-kikos-home.png` | 4 sahne |

...
> *Standard template for all Pompom Hills environment bibles.*
> *Every world bible must follow this exact structure.*

---

```markdown
# Environment Bible — [WORLD NAME]

> **Version 2.0** — Production pipeline standard.
...
[1-2 sentences describing what this place is.]

---

## Purpose

[Why this place exists in the world. What function it serves.]

---

## Why This World Exists ⭐

[Design rationale. Why did the creators choose to build this place?]

Example:
> This world exists because preschool children naturally enjoy [activity].
> The world encourages [value] without [negative] and [value] without [negative].
...
**Purpose:** Props and materials reference.
...
**Purpose for OpenArt:** [Explanation]
...
| Consistent scale | ... |
| No characters in references | ... |
| References are stable | ... |

### Shot Creation Order

\```
1. Load Hero View (mandatory)
2. Add Entrance/Trail View if needed
3. Add Detail View if needed
4. Load character reference
5. Create shot
...
[Natural story moments that could happen here]

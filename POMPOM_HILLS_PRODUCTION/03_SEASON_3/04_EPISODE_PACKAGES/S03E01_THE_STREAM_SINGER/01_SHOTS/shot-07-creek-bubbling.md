# The Stream Singer — Shot 07 — Creek Bubbling
...
Previous shot: Wind rustled the leaves. Three sounds blended together.

They move to a spot where the creek bubbles over round stones.
...
The creek bubbles over round stones, making a soft rhythmic pattern. Mimo taps a stone gently with a stick — a new sound! Kiko watches, delighted. Rainbow Creek — stream, stones, warm morning light. Medium, 50mm, static, {style} {camera} {lighting}
...
```
Mimo: Listen to the bubbles!
Kiko: It's like a song!
```
...
| Time | Action | Camera |
|---|---|---|
| 0-3 sn | First frame matches. Creek bubbles over stones. | Medium, 50mm, static |
| 3-7 sn | Rhythmic bubbling pattern — soft and musical | Medium, 50mm, static |
| 7-10 sn | Mimo picks up a stick, taps a stone gently | Medium, 50mm, static |
| 10-13 sn | A new sound! Kiko claps softly | Medium, 50mm, static |
| 13-15 sn | Mimo taps again — creating a rhythm | Medium, 50mm, static |
...
- Creek bubbling — rhythmic pattern
- Stone tap — soft "tok" sound
- Kiko's soft clap

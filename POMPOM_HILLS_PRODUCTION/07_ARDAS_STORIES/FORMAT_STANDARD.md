# Arda's Stories — Format Standard

> Character-led stories about movement, play, persistence, and small everyday adventures.
...
Use only when natural to the story:

- "Let's go!"
- "One more time?"
- "I found it!"
- "Try, try, try again. Slow down, watch, and try again."

Dialogue remains short. Physical action, facial expression, object movement, and sound carry the
...
## Object and Movement Rules

- Recurring props must use their canonical item specifications.
- Ball stories use the canonical Pompom Ball from
  `POMPOM_HILLS_PRODUCTION/00_GLOBAL_RULES/POMPOM_ITEMS/ball/01-pompom-ball.md`.
- The Pompom Ball is soft, fluffy, slow, floaty, and preschool-safe. It is not a realistic football.
- An object may have a recognisable sound pattern, but it must not be given speech or an independent
  personality unless a future canon change explicitly allows it.
- Cause and effect must be visible: stronger push → higher bounce; slope → faster roll; waiting →
  easier catch.
...
- `00-CORE/17_VIDEO_GENERATION_STANDARD.md`
- `00-CORE/18_VIDEO_STYLE_AND_RETENTION_STANDARD.md`
- `POMPOM_HILLS_PRODUCTION/00_GLOBAL_RULES/SHORTS_PRODUCTION_STANDARD.md`
- `POMPOM_HILLS_PRODUCTION/00_GLOBAL_RULES/MICRO_OPENING_AND_CLOSING_STANDARD.md`

---

## Sound Identity

Object sounds may form a gentle recurring rhythm:

| Movement | Suggested sound |
|---|---|
| Soft bounce | `poof` |
| Higher soft bounce | `boing` |
| Slow roll | `frrr-frrr` |
| Faster roll | `vrr-vrr` |
| Touching a rounded obstacle | `tink` |
| Soft contact with grass or clothing | `puff` |

Sounds must remain soft, natural, calming, and subordinate to the story.

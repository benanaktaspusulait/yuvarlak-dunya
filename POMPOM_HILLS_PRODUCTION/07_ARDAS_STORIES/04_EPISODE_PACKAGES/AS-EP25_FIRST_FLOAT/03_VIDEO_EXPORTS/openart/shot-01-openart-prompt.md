...
- Video ref only: approved Shot 01 Take Shot as `@image5`.
...
15s single take. `@image5` only. Garden, Arda, one coral-red/yellow/blue boat with open sky-blue cockpit. Boat and cockpit begin completely dry; one boat only. Manual Arda voice; speak:

# Shot 04 — OpenArt Prompt — shot-04-splash

## Continuity Source

Shot 04 begins from the exact approved final frame of Shot 03. The previous shot’s final frame is the complete first-frame authority. Preserve Arda and Luca’s identities, body poses, relative positions, hand positions, feet positions, puddle geometry, reflection, camera axis, lighting and all visible garden landmarks at frame 0. Do not restart, teleport, recompose, mirror or regenerate the scene.

Required input: attach the exact approved final frame of Shot 03 as the first-frame reference before generating this shot. Do not claim that an image is linked when none is supplied.
...
Water movement may briefly obscure or naturally distort the reflection, but the reflection never moves independently or leaves the water.
...
At frame 0, Arda and Luca continue exactly from Shot 03's final frame. Arda has both feet planted at the near edge of the puddle. No jump, airborne pose or splash has started. Luca remains camera-left on dry ground.

Arda's Home Garden after rain, wet grass, rounded shrubs, warm wooden fence, clearing sky with soft blue and white clouds. Golden afternoon sunlight. Arda (fluffy dark brown hair, sky blue T-shirt, light blue trousers, tan shoes) is standing at the edge of the large puddle, continues from Shot 03, and makes two joyful jumps into the shallow water. Luca (wavy messy dark brown hair, cream shirt with leaf green sleeves, khaki green shorts, orange sneakers) remains outside the puddle on the same side, camera-left, reacting with happy encouragement. Each jump creates a small, readable and controlled shallow splash around Arda’s shoes. The action is joyful but never chaotic or violent. Arda lands safely in the shallow part of the puddle. Fresh, bright post-rain atmosphere, soft pastel colours, rounded safe shapes, only Arda and Luca; no third character, horizontal 16:9 aspect ratio, soft 3D rounded preschool cartoon, pastel colours, warm matte finish, gentle expressive faces, safe rounded shapes, calm Pompom Hills visual style, no photorealism, locked child-eye-level medium-wide composition with a stable 32mm lens feeling, consistent camera axis, Arda and Luca clearly visible, warm golden afternoon post-rain lighting, soft diffuse shadows, clear blue sky, no harsh contrast, no HDR, no glossy highlights
...
- 0.0–2.0s: Arda and Luca continue exactly from Shot 03. Arda bends his knees and prepares to jump. Both of Arda’s feet remain at the puddle edge. No jump has started.
- 0.2–1.0s: Luca speaks.
- 1.1–1.8s: Arda speaks.
- 2.0–2.5s: Arda speaks.
- 2.5–5.0s: Arda performs the first readable two-foot jump: takeoff, brief airborne moment and landing with both feet in the shallow water. Create one small controlled splash.
- 5.0–6.2s: Arda remains standing with both feet planted while the first splash settles. Luca remains outside the puddle.
- 6.2–6.8s: Luca speaks.
- 6.8–9.8s: Arda performs the second readable two-foot jump: takeoff, brief airborne moment and landing with both feet planted. Create one small controlled splash.
- 9.8–13.5s: Arda remains standing safely in the same shallow part of the puddle. Luca remains at the dry edge.
- 13.5–15.0s: The water settles into gentle small ripples. Arda is not airborne at the final frame.

Do not merge the two jumps into one continuous jump. Do not teleport Arda. Do not make Luca jump into the puddle.
...
Arda is standing with both feet planted in the shallow water of the same large puddle. Luca is standing at the dry edge, camera-left of Arda. The splashes have settled into gentle small ripples. Their identities, clothing, and the garden background remain unchanged.

## Camera Direction

32mm lens feeling at child eye level. Stable medium-wide composition showing Arda jumping and Luca reacting at the dry edge. The camera holds steady so the action is clearly visible. No autonomous camera movement, no pan, no tilt, no zoom, no camera shake, no lens change, no sudden close-up, no focus-pull effect, no unpredictable reframing.

## Sound

Soft outdoor post-rain ambience. Two clear 'splash' sounds (treated as SFX). Arda and Luca speak the scheduled dialogue. No music, no background music, no melody, no song, no soundtrack.
...
- [ ] Arda lands and stands at the end; not airborne.

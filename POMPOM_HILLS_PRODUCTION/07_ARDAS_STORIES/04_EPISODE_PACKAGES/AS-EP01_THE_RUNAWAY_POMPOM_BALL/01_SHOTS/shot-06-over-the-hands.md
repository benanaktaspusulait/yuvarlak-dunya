# The Runaway Pompom Ball — Shot 06 — Over the Hands
...
- The open garden play gate is visible in the background — the ball's escape route.
...
Background locked from first frame. The garden — soft grass, rounded shrubs, safe play gate, warm afternoon light — remains stable. Only Arda and the Pompom Ball move. The play gate is visible but not yet the focus.
...
> **Hook Purpose:** The ball passing over Arda's hands creates the episode's central problem. Arda's surprised "Oh!" is gentle and age-appropriate — not distressed.
...
Surprise and anticipation: Arda's surprise at the ball rolling away is gentle and curious, not distressed. The moment creates a small problem that invites the viewer to wonder what happens next.

---

## Safe-Exposure Notes

No falls, no rough play, no aggressive movements. The ball rolls away gently on soft grass. Arda's surprise is mild and playful.

# Shot 12 — OpenArt Prompt — shot-12-tink-then-left

## Visual Prompt

Safe connecting play path, soft green grass, warm morning sunlight. The Pompom Ball — soft,
fluffy, pastel-coloured, round — lightly touches a small rounded Pompom stone on the path
and changes direction, rolling left. Arda (energetic boy, brown curly hair, orange t-shirt,
blue shorts) changes his pointing arm to point left. Soft rounded flowers and gentle green
...
The path and Pompom stone background is locked from the first frame; keep stone position,
flower positions, grass edges stable.

Do not display dialogue as on-screen text. No speech bubbles. No captions. No text.

## Camera Direction

32mm wide at child eye level, framing the ball touching the stone and curving left, with Arda
changing his pointing arm. Gentle follow along the new direction. Warm, steady framing. No
fast zooms, no dramatic angles.

## Sound

Soft outdoor path ambience: gentle birds chirping, light breeze, calm warm atmosphere. The
Pompom Ball makes a soft "tink" as it touches the stone, then a rolling sound as it curves
left. Arda's voice is playful and pointing: "Now left!" Natural ambience only. No music, no

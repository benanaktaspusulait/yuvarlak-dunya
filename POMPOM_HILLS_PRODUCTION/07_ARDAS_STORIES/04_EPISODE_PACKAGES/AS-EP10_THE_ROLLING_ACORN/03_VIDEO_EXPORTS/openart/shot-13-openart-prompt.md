# Shot 13 — OpenArt Prompt — shot-13-leaf-patch
...
diameter — in his other hand. He looks at the acorn with a speculative smile. Warm morning
dappled sunlight, soft shadows, rounded safe shapes, pastel colours, no other characters,
{style} {camera} {lighting}

Use @image1 as continuity from Shot 12.

The garden background is locked from the first frame; keep tree, leaves, grass, path, daisies,
fence, house stable.
...
32mm at child eye level, framing Arda at the leaf pile touching leaves. Close-up on leaves
crackling. Warm, steady framing. No fast zooms, no dramatic angles.

## Sound

Soft outdoor garden ambience: gentle birds chirping. Leaves crackling softly. Arda's voice is
curious: "Leaves! What happens on leaves?" Natural ambience only. No music, no background

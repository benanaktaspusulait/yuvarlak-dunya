# Shot 12 — OpenArt Prompt — shot-12-medium-on-sand

## Visual Prompt

Arda's Home garden, warm morning sunlight, small sandy patch beside the garden path, green
grass, rounded tree in background. Arda (energetic boy, brown curly hair, orange t-shirt, blue
shorts) places the small round acorn — warm brown, smooth, 3 cm diameter — on the sand and
pushes it. The acorn rolls — faster than on moss, but slower than on the smooth path. Arda
watches it roll and nods slowly, comparing. Warm morning dappled sunlight, soft shadows, rounded
safe shapes, pastel colours, no other characters, {style} {camera} {lighting}

Use @image1 as continuity from Shot 11.

The garden background is locked from the first frame; keep path, sand, grass, tree, daisies,
fence, house stable.
...
32mm at child eye level, close-up on the acorn as it rolls on sand at medium speed. Arda
watches and nods. Warm, steady framing. No fast zooms, no dramatic angles.

## Sound

Soft outdoor garden ambience: gentle birds chirping. Medium rolling: "frrr-frrr" on sand.
Soft sand rustle. Arda's voice is thoughtful: "Not so fast. Not so slow. Sand is in the
middle!" Natural ambience only. No music, no background music, no melody, no song, no
...
- [ ] Acorn rolls medium speed on sand
- [ ] Sandy patch visible
